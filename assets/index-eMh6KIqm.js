...
`)){const c=i.trim();if(!c){s=null;continue}if(c.startsWith("- ")&&s){const b=r[s],y=Sn(c.slice(2).trim()),w=Array.isArray(b)?b:[];w.push(y),r[s]=w;continue}const l=i.indexOf(":");if(l===-1){s=null;continue}const d=i.slice(0,l).trim(),g=i.slice(l+1).trim();if(!g){r[d]=[],s=d;continue}r[d]=Sn(g),s=null}return{frontmatter:r,body:o}}function Sn(e){return e.startsWith("[")&&e.endsWith("]")?e.slice(1,-1).split(",").map(n=>n.trim().replace(/^['"]|['"]$/g,"")).filter(Boolean):e==="true"?!0:e==="false"?!1:e.replace(/^['"]|['"]$/g,"")}function te(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function qa(e){return/^(https?:|data:|blob:|\/)/.test(e)?e:`${"/".endsWith("/")?"/":"//"}${e.replace(/^\/+/,"")}`}function ot(e){return/^https?:\/\//.test(e)}function Qe(e){return e.trim().replace(/^@/,"").toLowerCase()}function Va(e){var t;if(typeof e.url=="string")return e.url;if(typeof e.profileUrl=="string")return e.profileUrl;const n=(t=e.socials)==null?void 0:t.find(a=>a.social==="github");if(typeof(n==null?void 0:n.url)=="string")return n.url;if(typeof(n==null?void 0:n.username)=="string")return`https://github.com/${n.username.replace(/^@/,"")}`;if(typeof e.username=="string")return`https://github.com/${e.username.replace(/^@/,"")}`}function ja(e,n){if(typeof e!="string"||!e.trim())throw new Error(`Invalid article author in ${n}`);const t=Qe(e),a=Ga.find(o=>Qe(o.username??o.name)===t||Qe(o.name)===t);return a?{name:a.name,url:Va(a),avatar:typeof a.avatar=="string"?a.avatar:void 0}:ot(e)?{name:e,url:e}:{name:e}}function Ka(e,n){if(!/^(https?:\/\/|\/|\.\/|\.\.\/|[A-Za-z0-9/_-])/.test(n))return Se(e);const t=te(n),a=ot(n)?' target="_blank" rel="noreferrer"':"";return`<a href="${t}"${a}>${Se(e)}</a>`}function Se(e){return te(e).replace(/`([^`]+)`/g,"<code>$1</code>").replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>").replace(/\*([^*]+)\*/g,"<em>$1</em>")}function Za(e,n){let t=0;for(let a=n;a<e.length;a+=1){const o=e[a];if(o==="("){t+=1;continue}if(o===")"){if(t===0)return a;t-=1}}return-1}function le(e){let n="",t=0;for(;t<e.length;){const a=e.indexOf("[",t);if(a===-1){n+=Se(e.slice(t));break}const o=e.indexOf("]",a+1);if(o===-1||e[o+1]!=="("){n+=Se(e.slice(t,a+1)),t=a+1;continue}const r=o+2,s=Za(e,r);if(s===-1){n+=Se(e.slice(t,a+1)),t=a+1;continue}n+=Se(e.slice(t,a)),n+=Ka(e.slice(a+1,o),e.slice(r,s)),t=s+1}return n}function Ya(e){const n=e.toLowerCase();return{js:"JavaScript",javascript:"JavaScript",json:"JSON",md:"Markdown",markdown:"Markdown",sh:"Shell",shell:"Shell",swift:"Swift",ts:"TypeScript",typescript:"TypeScript",yaml:"YAML",yml:"YAML"}[n]??(e?e[0].toUpperCase()+e.slice(1):"Code")}function Xa(e){var o;const n=e.match(/(?:^|\s)(?:title|filename)=["']([^"']+)["']/),t=((o=e.split(/\s+/)[0])==null?void 0:o.replace(/[^\w#+-]/g,""))??"",a=(n==null?void 0:n[1])??e.replace(t,"").trim().replace(/^["']|["']$/g,"");return{language:t,title:a}}function Ja(e,n,t){const a=Ya(n);return`
  ...
  `}function Qa(e){const n=e.match(/^!\[([^\]]*)\]\(([^)\s]+)(?:\s+"([^"]+)")?\)$/),t=e.match(/^::video\[([^\]]*)\]\(([^)\s]+)(?:\s+"([^"]+)")?\)$/),a=n??t;if(!a)return null;const[,o,r,s]=a,i=qa(r),c=s||o,l=!!t||/\.(mp4|webm|ogg|mov)$/i.test(r),d=l?`<video controls playsinline preload="metadata" src="${te(i)}">${te(o)}</video>`:`<img src="${te(i)}" alt="${te(o)}" loading="lazy" role="button" tabindex="0" aria-label="Open image fullscreen" data-article-lightbox-image />`;return`
    <figure class="article-media ${l?"article-media-video":"article-media-image"}">
      ${d}
      ${c?`<figcaption>${le(c)}</figcaption>`:""}
    </figure>
  `}function es(e){const n=[];let t=!1;const a=()=>{t&&(n.push("</ul>"),t=!1)};for(const o of e){const r=o.trim();if(!r){a();continue}if(r.startsWith("- ")){t||(n.push("<ul>"),t=!0),n.push(`<li>${le(r.slice(2))}</li>`);continue}a(),n.push(`<p>${le(r)}</p>`)}return a(),n.join(`
`)}function ns(e,n,t){const a=["note","tip","warning","danger","info"].includes(e)?e:"note";return`
    <aside class="article-callout article-callout-${a}">
      ...
      <div>
        <p class="article-callout-title">${le(n||{danger:"Important",info:"Info",note:"Note",tip:"Tip",warning:"Warning"}[a])}</p>
        ${es(t)}
      </div>
    </aside>
...
struct PlayerSystem: System {
      ...
      <section class="container content-restriction header-container">
        <a class="header-logo" href="${H("/")}" aria-label="AdaEngine home">
          <picture class="header-logo-picture">
            ...
            <img src="${W("images/ae_logo.svg")}" alt="AdaEngine" />
          </picture>
          <h2>${ws}</h2>
        </a>
        ...
        <nav aria-label="Main navigation">
          <ul class="navigation">
            ...
            <li class="navigation-item download-button"><a class="navigation-item-link" href="${H("/download")}">Download <span class="download-version" data-download-version>v${de.version}</span></a></li>
          </ul>
        </nav>
      </section>
    </header>
    ...
    <section class="hero-section safe-area-insets">
      <div class="hero-copy">
        ...
        <div class="hero-actions">
          <a class="header-buttons" href="${H("/download")}">Download <span class="download-version" data-download-version>v${de.version}</span></a>
          <a class="header-buttons-github" href="https://github.com/${pt}" aria-label="AdaEngine on GitHub">
  ...
  `:""}function mt(e=[]){const n=e[0]??"News";return`<span class="blog-entry-tag blog-entry-tag-${["release","tutorial","engineering","markdown","frontmatter","vite"].find(a=>n.toLowerCase().includes(a))??"default"}">${N(n)}</span>`}function Ms(e,n){return e.image??xn[n%xn.length]??gt}function Rs(){se.innerHTML=`
    ${ie()}
  ...
  `}async function Ds(e){const n=await lt(),t=cs(n,e);if(!t){ze("Demo not found","Check the address or return to the demos page.");return}dn(hs(t));const a=await rs(t),o=n.commit??"main",r=`https://github.com/${n.repository}/blob/${o}/${t.sourcePath}`;se.innerHTML=`
    ${ie()}
  ...
  `:""}function Gs(){const e=Es.learn;se.innerHTML=`
    ${ie()}
    ...
    ${oe()}
  `}function zs(e){if(e==="learn"){Gs();return}if(e==="community"){qs();return}if(e==="donate"){Ws();return}}function Ws(){se.innerHTML=`
    ${ie()}
  ...
  `}function Vs(){se.innerHTML=`
    ...
    ${oe()}
    ${Us()}
  `}function js(e){const n=os(e);if(!n){ze("Article not found","Check the address or return to the blog.");return}dn(fs(n)),se.innerHTML=`
    ${ie()}
  ...
  `}function ze(e="Page not found",n="This route does not exist yet."){se.innerHTML=`
    ${ie()}
    <main class="page-shell">
  ...
  `}function Js(){const e=document.querySelector(".article-content"),n=document.querySelector("[data-mobile-reader-nav]"),t=document.querySelector("[data-mobile-toc-toggle]"),a=document.querySelector("[data-mobile-toc-sheet]"),o=Array.from(document.querySelectorAll(".article-content h2[id], .article-content h3[id]")),r=Array.from(document.querySelectorAll("[data-article-toc-link]")),s=Array.from(document.querySelectorAll("[data-article-progress-fill]")),i=Array.from(document.querySelectorAll("[data-article-progress-label]")),c=Array.from(document.querySelectorAll("[data-current-section]"));if(!e||!o.length||!r.length)return;let l,d;const g=E=>{if(!(!t||!a||!n)){if(window.clearTimeout(l),t.setAttribute("aria-expanded",String(E)),E){a.hidden=!1,n.classList.remove("is-closing"),n.classList.add("is-open");return}n.classList.remove("is-open"),n.classList.add("is-closing"),l=window.setTimeout(()=>{a.hidden=!0,n.classList.remove("is-closing")},520)}},b=E=>{const S=document.getElementById(E);S&&(S.scrollIntoView({behavior:"smooth",block:"start"}),g(!1))},y=E=>{const S=E.closest(".article-toc-list, .article-mobile-toc-list");if(!S)return;const _=S.getBoundingClientRect(),T=E.getBoundingClientRect(),I=16,P=T.top<_.top+I,$=T.bottom>_.bottom-I;if(!P&&!$)return;const L=P?T.top-_.top-I:T.bottom-_.bottom+I;S.scrollTo({top:S.scrollTop+L,behavior:"smooth"})};r.forEach(E=>{E.addEventListener("click",S=>{const _=E.dataset.articleTocLink;_&&(S.preventDefault(),history.replaceState(null,"",`${window.location.pathname}${window.location.search}#${_}`),b(_))})}),t==null||t.addEventListener("click",()=>{const E=t.getAttribute("aria-expanded")==="true";g(!E)}),document.addEventListener("keydown",E=>{E.key==="Escape"&&g(!1)}),document.addEventListener("click",E=>{!n||!E.target||n.contains(E.target)||g(!1)});const w=()=>{var F;const E=window.scrollY+Math.min(180,window.innerHeight*.28),S=o.slice().reverse().find(O=>O.getBoundingClientRect().top+window.scrollY<=E)??o[0],_=S.id,T=e.offsetTop,I=e.offsetTop+e.scrollHeight-window.innerHeight,P=I<=T?1:Math.min(1,Math.max(0,(window.scrollY-T)/(I-T))),$=`${Math.round(P*100)}%`,L=((F=S.textContent)==null?void 0:F.trim())||"Start",Z=_!==d;d=_,s.forEach(O=>{O.style.transform=`scaleX(${P})`}),i.forEach(O=>{O.textContent=$}),c.forEach(O=>{O.textContent=L}),r.forEach(O=>{const j=O.dataset.articleTocLink===_;O.classList.toggle("is-active",j),O.setAttribute("aria-current",j?"true":"false"),j&&Z&&y(O)})};window.addEventListener("scroll",w,{passive:!0}),window.addEventListener("resize",w),w()}function Qs(){const e=Array.from(document.querySelectorAll("[data-demo-category-link]")),n=e.map(r=>{var s;return(s=document.getElementById(r.dataset.demoCategoryLink??""))==null?void 0:s.closest(".demo-group")}).filter(r=>!!r);if(!e.length||!n.length)return;let t;const a=r=>{const s=r.closest(".demo-category-list");if(!s||s.scrollWidth<=s.clientWidth)return;const i=s.getBoundingClientRect(),c=r.getBoundingClientRect(),l=12,d=c.left<i.left+l,g=c.right>i.right-l;if(!d&&!g)return;const b=d?c.left-i.left-l:c.right-i.right+l;s.scrollTo({left:s.scrollLeft+b,behavior:"smooth"})},o=()=>{var l;const r=window.scrollY+Math.min(180,window.innerHeight*.28),i=(l=(n.slice().reverse().find(d=>d.getBoundingClientRect().top+window.scrollY<=r)??n[0]).querySelector("h2[id]"))==null?void 0:l.id,c=i!==t;t=i,e.forEach(d=>{const g=d.dataset.demoCategoryLink===i;d.classList.toggle("is-active",g),g?d.setAttribute("aria-current","location"):d.removeAttribute("aria-current"),g&&c&&a(d)})};e.forEach(r=>{r.addEventListener("click",s=>{const i=r.dataset.demoCategoryLink,c=i?document.getElementById(i):null;!c||!i||(s.preventDefault(),history.replaceState(null,"",`${window.location.pathname}${window.location.search}#${i}`),c.scrollIntoView({behavior:"smooth",block:"start"}))})}),window.addEventListener("scroll",o,{passive:!0}),window.addEventListener("resize",o),o()}function ft(e){return[{id:"macos",title:"Mac",description:"The native editor for your Mac. Build with AdaScript and Swift."},{id:"windows",title:"Windows",description:"Create AdaEngine games on your Windows PC."},{id:"linux",title:"Linux",description:"Build with the open-source engine on Linux."}].map(({id:t,title:a,description:o})=>{const r=Nn(t,e);return`<article class="platform-download" aria-labelledby="download-${t}">
      ...
      <div class="platform-download-actions">${r.length?r.map(s=>`<a class="header-buttons" href="${N(s.url)}">${Et(s)}</a>`).join(""):`<span class="download-status">Installer coming soon</span><a class="download-source-link" href="${N(e.url)}">Get the source code ↗</a>`}</div>
  ...
  </article>`}function ei(){se.innerHTML=`${ie()}
  ...
  `}function oi(){const e=document.querySelector("[data-article-lightbox]"),n=e==null?void 0:e.querySelector("[data-article-lightbox-preview]"),t=e==null?void 0:e.querySelector("[data-article-lightbox-caption]"),a=e==null?void 0:e.querySelector(".article-image-lightbox-close");let o=null;if(!e||!n||!t)return;const r=()=>{e.hidden=!0,n.removeAttribute("src"),document.body.classList.remove("article-lightbox-open"),o instanceof HTMLElement&&o.focus()},s=i=>{var d,g;const c=i.closest("figure"),l=((g=(d=c==null?void 0:c.querySelector("figcaption"))==null?void 0:d.textContent)==null?void 0:g.trim())??"";o=document.activeElement,n.src=i.currentSrc||i.src,n.alt=i.alt,t.textContent=l,t.hidden=!l,e.hidden=!1,document.body.classList.add("article-lightbox-open"),a==null||a.focus()};document.querySelectorAll("[data-article-lightbox-image]").forEach(i=>{i.addEventListener("click",()=>s(i)),i.addEventListener("keydown",c=>{c.key!=="Enter"&&c.key!==" "||(c.preventDefault(),s(i))})}),e.querySelectorAll("[data-article-lightbox-close]").forEach(i=>{i.addEventListener("click",r)}),document.addEventListener("keydown",i=>{i.key==="Escape"&&!e.hidden&&r()})}function ri(){const e=document.querySelector(".demo-player:not(.demo-player-empty)"),n=e==null?void 0:e.querySelector("[data-demo-fullscreen]");if(!e||!n)return;const t=document,a=e,o=document.fullscreenEnabled||t.webkitFullscreenEnabled||typeof e.requestFullscreen=="function"||typeof a.webkitRequestFullscreen=="function",r=()=>document.fullscreenElement??t.webkitFullscreenElement??null,s=()=>r()===e;let i=!1;const c=()=>{i=!0,e.classList.add("is-viewport-fullscreen"),document.body.classList.add("demo-viewport-fullscreen-open"),y()},l=()=>{i=!1,e.classList.remove("is-viewport-fullscreen"),document.body.classList.remove("demo-viewport-fullscreen-open"),y()},d=async()=>o?typeof e.requestFullscreen=="function"?(await e.requestFullscreen(),!0):typeof a.webkitRequestFullscreen=="function"?(await a.webkitRequestFullscreen(),!0):!1:!1,g=async()=>{try{if(await d())return}catch(w){console.warn("Native fullscreen is unavailable, using viewport fullscreen fallback",w)}c()},b=async()=>{var w;if(i){l();return}if(typeof document.exitFullscreen=="function"){await document.exitFullscreen();return}await((w=t.webkitExitFullscreen)==null?void 0:w.call(t))},y=()=>{const w=s()||i;e.classList.toggle("is-fullscreen",w),n.setAttribute("aria-label",w?"Exit demo fullscreen":"Open demo fullscreen"),n.title=w?"Exit fullscreen":"Open fullscreen"};n.addEventListener("click",async()=>{try{if(s()||i){await b();return}await g()}catch(w){console.error("Failed to toggle demo fullscreen",w)}}),document.addEventListener("fullscreenchange",y),document.addEventListener("webkitfullscreenchange",y),document.addEventListener("keydown",w=>{w.key==="Escape"&&i&&l()}),y()}function ci(){const e=document.querySelector(".demo-player:not(.demo-player-empty)"),n=e==null?void 0:e.querySelector("iframe");if(!e||!n)return;const t=document.createElement("canvas");t.width=1,t.height=1;const a=t.getContext("2d",{willReadFrequently:!0});if(!a)return;let o=0,r=0,s={red:34,green:211,blue:238};const i=(d,g,b)=>{s={red:Math.round(s.red*.7+d*.3),green:Math.round(s.green*.7+g*.3),blue:Math.round(s.blue*.7+b*.3)},e.style.setProperty("--demo-ambient",`${s.red} ${s.green} ${s.blue}`),e.classList.add("has-ambient-light")},c=d=>{if(d.origin!==window.location.origin)return;const g=d.data;if(!g||typeof g!="object"||g.type!=="ada-demo-ambient"||!Array.isArray(g.color)||g.color.length<3)return;const[b,y,w]=g.color.map(Number);[b,y,w].every(Number.isFinite)&&i(b,y,w)},l=()=>{var d;try{const g=(d=n.contentDocument)==null?void 0:d.querySelector("canvas");if(!g||g.width<=0||g.height<=0){r+=1,o=window.setTimeout(l,r<120?250:1e3);return}const b=Math.max(0,Math.floor(g.width*.5)),y=Math.max(0,Math.floor(g.height*.42));a.clearRect(0,0,1,1),a.drawImage(g,b,y,1,1,0,0,1,1);const[w,E,S,_]=a.getImageData(0,0,1,1).data;_>0&&w+E+S>8&&i(w,E,S),r=0,o=window.setTimeout(l,450)}catch{r+=1,o=window.setTimeout(l,r<12?450:1200)}};n.addEventListener("load",()=>{window.clearTimeout(o),r=0,o=window.setTimeout(l,500)}),window.addEventListener("message",c),o=window.setTimeout(l,500)}function li(){const e=document.querySelector(".showcase-carousel"),n=Array.from(document.querySelectorAll(".showcase-slide")),t=Array.from(document.querySelectorAll(".showcase-carousel-dot"));if(!e||n.length<2)return;let a=0,o;const r=i=>{a=(i+n.length)%n.length,n.forEach((c,l)=>{const d=l===a;c.classList.toggle("is-active",d),c.setAttribute("aria-hidden",String(!d)),c.querySelectorAll("a").forEach(g=>{g.tabIndex=d?0:-1})}),t.forEach((c,l)=>{c.classList.toggle("is-active",l===a),c.setAttribute("aria-current",l===a?"true":"false")})},s=()=>{window.clearInterval(o),o=window.setInterval(()=>{r(a+1)},5e3)};t.forEach((i,c)=>{i.addEventListener("click",()=>{r(c),s()})}),e.addEventListener("mouseenter",()=>window.clearInterval(o)),e.addEventListener("mouseleave",s),e.addEventListener("focusin",()=>window.clearInterval(o)),e.addEventListener("focusout",s),r(0),s()}ti().catch(e=>{console.error(e),ze("Page failed to load","Refresh the page or try again in a moment.")}).then(()=>{try{ai()}catch(e){console.error("Failed to initialize page interactions",e)}Is(),ni()});
