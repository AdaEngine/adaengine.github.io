...
struct PlayerSystem: System {
  ...
  `:""}function mt(e=[]){const n=e[0]??"News";return`<span class="blog-entry-tag blog-entry-tag-${["release","tutorial","engineering","markdown","frontmatter","vite"].find(a=>n.toLowerCase().includes(a))??"default"}">${N(n)}</span>`}function Ms(e,n){return e.image??xn[n%xn.length]??gt}function Rs(){ie.innerHTML=`
    ${oe()}
  ...
  `}function oi(){const e=document.querySelector("[data-article-lightbox]"),n=e==null?void 0:e.querySelector("[data-article-lightbox-preview]"),t=e==null?void 0:e.querySelector("[data-article-lightbox-caption]"),a=e==null?void 0:e.querySelector(".article-image-lightbox-close");let o=null;if(!e||!n||!t)return;const r=()=>{e.hidden=!0,n.removeAttribute("src"),document.body.classList.remove("article-lightbox-open"),o instanceof HTMLElement&&o.focus()},i=s=>{var d,g;const c=s.closest("figure"),l=((g=(d=c==null?void 0:c.querySelector("figcaption"))==null?void 0:d.textContent)==null?void 0:g.trim())??"";o=document.activeElement,n.src=s.currentSrc||s.src,n.alt=s.alt,t.textContent=l,t.hidden=!l,e.hidden=!1,document.body.classList.add("article-lightbox-open"),a==null||a.focus()};document.querySelectorAll("[data-article-lightbox-image]").forEach(s=>{s.addEventListener("click",()=>i(s)),s.addEventListener("keydown",c=>{c.key!=="Enter"&&c.key!==" "||(c.preventDefault(),i(s))})}),e.querySelectorAll("[data-article-lightbox-close]").forEach(s=>{s.addEventListener("click",r)}),document.addEventListener("keydown",s=>{s.key==="Escape"&&!e.hidden&&r()})}function ri(){const e=document.querySelector(".demo-player:not(.demo-player-empty)"),n=e==null?void 0:e.querySelector("[data-demo-fullscreen]");if(!e||!n)return;const t=document,a=e,o=document.fullscreenEnabled||t.webkitFullscreenEnabled||typeof e.requestFullscreen=="function"||typeof a.webkitRequestFullscreen=="function",r=()=>document.fullscreenElement??t.webkitFullscreenElement??null,i=()=>r()===e;let s=!1;const c=()=>{s=!0,e.classList.add("is-viewport-fullscreen"),document.body.classList.add("demo-viewport-fullscreen-open"),y()},l=()=>{s=!1,e.classList.remove("is-viewport-fullscreen"),document.body.classList.remove("demo-viewport-fullscreen-open"),y()},d=async()=>o?typeof e.requestFullscreen=="function"?(await e.requestFullscreen(),!0):typeof a.webkitRequestFullscreen=="function"?(await a.webkitRequestFullscreen(),!0):!1:!1,g=async()=>{try{if(await d())return}catch(w){console.warn("Native fullscreen is unavailable, using viewport fullscreen fallback",w)}c()},b=async()=>{var w;if(s){l();return}if(typeof document.exitFullscreen=="function"){await document.exitFullscreen();return}await((w=t.webkitExitFullscreen)==null?void 0:w.call(t))},y=()=>{const w=i()||s;e.classList.toggle("is-fullscreen",w),n.setAttribute("aria-label",w?"Exit demo fullscreen":"Open demo fullscreen"),n.title=w?"Exit fullscreen":"Open fullscreen"};n.addEventListener("click",async()=>{try{if(i()||s){await b();return}await g()}catch(w){console.error("Failed to toggle demo fullscreen",w)}}),document.addEventListener("fullscreenchange",y),document.addEventListener("webkitfullscreenchange",y),document.addEventListener("keydown",w=>{w.key==="Escape"&&s&&l()}),y()}function ci(){const e=document.querySelector(".demo-player:not(.demo-player-empty)"),n=e==null?void 0:e.querySelector("iframe");if(!e||!n)return;const t=document.createElement("canvas");t.width=1,t.height=1;const a=t.getContext("2d",{willReadFrequently:!0});if(!a)return;let o=0,r=0,i={red:34,green:211,blue:238};const s=(d,g,b)=>{i={red:Math.round(i.red*.7+d*.3),green:Math.round(i.green*.7+g*.3),blue:Math.round(i.blue*.7+b*.3)},e.style.setProperty("--demo-ambient",`${i.red} ${i.green} ${i.blue}`),e.classList.add("has-ambient-light")},c=d=>{if(d.origin!==window.location.origin)return;const g=d.data;if(!g||typeof g!="object"||g.type!=="ada-demo-ambient"||!Array.isArray(g.color)||g.color.length<3)return;const[b,y,w]=g.color.map(Number);[b,y,w].every(Number.isFinite)&&s(b,y,w)},l=()=>{var d;try{const g=(d=n.contentDocument)==null?void 0:d.querySelector("canvas");if(!g||g.width<=0||g.height<=0){r+=1,o=window.setTimeout(l,r<120?250:1e3);return}const b=Math.max(0,Math.floor(g.width*.5)),y=Math.max(0,Math.floor(g.height*.42));a.clearRect(0,0,1,1),a.drawImage(g,b,y,1,1,0,0,1,1);const[w,E,S,_]=a.getImageData(0,0,1,1).data;_>0&&w+E+S>8&&s(w,E,S),r=0,o=window.setTimeout(l,450)}catch{r+=1,o=window.setTimeout(l,r<12?450:1200)}};n.addEventListener("load",()=>{window.clearTimeout(o),r=0,o=window.setTimeout(l,500)}),window.addEventListener("message",c),o=window.setTimeout(l,500)}function li(){const e=document.querySelector(".showcase-carousel"),n=Array.from(document.querySelectorAll(".showcase-slide")),t=Array.from(document.querySelectorAll(".showcase-carousel-dot"));if(!e||n.length<2)return;let a=0,o;const r=s=>{a=(s+n.length)%n.length,n.forEach((c,l)=>{const d=l===a;c.classList.toggle("is-active",d),c.setAttribute("aria-hidden",String(!d)),c.querySelectorAll("a").forEach(g=>{g.tabIndex=d?0:-1})}),t.forEach((c,l)=>{c.classList.toggle("is-active",l===a),c.setAttribute("aria-current",l===a?"true":"false")})},i=()=>{window.clearInterval(o),o=window.setInterval(()=>{r(a+1)},5e3)};t.forEach((s,c)=>{s.addEventListener("click",()=>{r(c),i()})}),e.addEventListener("mouseenter",()=>window.clearInterval(o)),e.addEventListener("mouseleave",i),e.addEventListener("focusin",()=>window.clearInterval(o)),e.addEventListener("focusout",i),r(0),i()}ti().catch(e=>{console.error(e),ze("Page failed to load","Refresh the page or try again in a moment.")}).then(()=>{try{ai()}catch(e){console.error("Failed to initialize page interactions",e)}Is(),ni()});
