const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/cloud-CC7CsGsz.js","assets/cloud-BFs_nmYF.css"])))=>i.map(i=>d[i]);
(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const r of o)if(r.type==="childList")for(const s of r.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function t(o){const r={};return o.integrity&&(r.integrity=o.integrity),o.referrerPolicy&&(r.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?r.credentials="include":o.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(o){if(o.ep)return;o.ep=!0;const r=t(o);fetch(o.href,r)}})();const Et="modulepreload",vt=function(e){return"/"+e},un={},At=function(n,t,a){let o=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),i=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));o=Promise.allSettled(t.map(c=>{if(c=vt(c),c in un)return;un[c]=!0;const l=c.endsWith(".css"),d=l?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${d}`))return;const p=document.createElement("link");if(p.rel=l?"stylesheet":Et,l||(p.as="script"),p.crossOrigin="",p.href=c,i&&p.setAttribute("nonce",i),document.head.appendChild(p),l)return new Promise((b,y)=>{p.addEventListener("load",b),p.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(s){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=s,window.dispatchEvent(i),!i.defaultPrevented)throw s}return o.then(s=>{for(const i of s||[])i.status==="rejected"&&r(i.reason);return n().catch(r)})},St="https://apps.apple.com/app/id6809145006",ne={version:"1.0",url:"https://github.com/AdaEngine/AdaEngine/releases/tag/editor-v1.0-1",assets:[{name:"AdaEngine-1.0-1-macOS.zip",url:"https://github.com/AdaEngine/AdaEngine/releases/download/editor-v1.0-1/AdaEngine-1.0-1-macOS.zip"}]};function pn(e){if(typeof e=="string")try{const n=new URL(e);return n.protocol==="https:"&&n.hostname==="github.com"&&!n.username&&!n.password&&n.pathname.startsWith("/AdaEngine/AdaEngine/releases/")?n.href:void 0}catch{return}}function _t(e){var s;if(!e||typeof e!="object")return;const n=e,t=pn(n.html_url);if(n.draft||n.prerelease||typeof n.tag_name!="string"||!t)return;const o=((s=n.tag_name.match(/^editor-v(\d+\.\d+(?:\.\d+)?)-\d+$/))==null?void 0:s[1])??n.tag_name.replace(/^(?:editor-)?v/,"");if(!/^\d+\.\d+(?:\.\d+)?(?:[-.][a-zA-Z0-9]+)*$/.test(o))return;const r=[];if(Array.isArray(n.assets))for(const i of n.assets){if(!i||typeof i!="object")continue;const c=pn(i.browser_download_url);typeof i.name=="string"&&c&&r.push({name:i.name,url:c})}return{version:o,url:t,assets:r}}function Cn(e,n){return n.assets.filter(({name:t})=>/\.(?:sha\d*|sig|asc|blockmap)$/i.test(t)?!1:e==="windows"?/\.(?:exe|msi)$/i.test(t)||/(?:windows|win32|win64).*\.zip$/i.test(t):e==="macos"?/\.(?:dmg|pkg)$/i.test(t)||/(?:macos|mac|darwin|osx).*\.zip$/i.test(t):/\.appimage$/i.test(t)||/linux.*\.(?:zip|tar\.gz|tar\.xz|deb|rpm)$/i.test(t))}function Tt(e){return/(?:arm64|aarch64|apple-silicon)/i.test(e.name)?"Download · ARM64":/(?:x86_64|amd64|x64|intel)/i.test(e.name)?"Download · Intel / AMD":"Download"}function xt(e){if(!Array.isArray(e))return ne;const n=e.map(_t).filter(t=>t!==void 0);return n.find(t=>["macos","windows","linux"].some(a=>Cn(a,t).length>0))??(ne.assets.length?ne:n[0]??ne)}async function kt(){try{const e=await fetch("https://api.github.com/repos/AdaEngine/AdaEngine/releases?per_page=20",{headers:{Accept:"application/vnd.github+json"},signal:AbortSignal.timeout(5e3)});if(!e.ok)return ne;const n=await e.json();return xt(n)}catch{}return ne}function It(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}function $n(e){return e instanceof Map?e.clear=e.delete=e.set=function(){throw new Error("map is read-only")}:e instanceof Set&&(e.add=e.clear=e.delete=function(){throw new Error("set is read-only")}),Object.freeze(e),Object.getOwnPropertyNames(e).forEach(n=>{const t=e[n],a=typeof t;(a==="object"||a==="function")&&!Object.isFrozen(t)&&$n(t)}),e}class gn{constructor(n){n.data===void 0&&(n.data={}),this.data=n.data,this.isMatchIgnored=!1}ignoreMatch(){this.isMatchIgnored=!0}}function Rn(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function ge(e,...n){const t=Object.create(null);for(const a in e)t[a]=e[a];return n.forEach(function(a){for(const o in a)t[o]=a[o]}),t}const Nt="</span>",mn=e=>!!e.scope,Ct=(e,{prefix:n})=>{if(e.startsWith("language:"))return e.replace("language:","language-");if(e.includes(".")){const t=e.split(".");return[`${n}${t.shift()}`,...t.map((a,o)=>`${a}${"_".repeat(o+1)}`)].join(" ")}return`${n}${e}`};class $t{constructor(n,t){this.buffer="",this.classPrefix=t.classPrefix,n.walk(this)}addText(n){this.buffer+=Rn(n)}openNode(n){if(!mn(n))return;const t=Ct(n.scope,{prefix:this.classPrefix});this.span(t)}closeNode(n){mn(n)&&(this.buffer+=Nt)}value(){return this.buffer}span(n){this.buffer+=`<span class="${n}">`}}const fn=(e={})=>{const n={children:[]};return Object.assign(n,e),n};class tn{constructor(){this.rootNode=fn(),this.stack=[this.rootNode]}get top(){return this.stack[this.stack.length-1]}get root(){return this.rootNode}add(n){this.top.children.push(n)}openNode(n){const t=fn({scope:n});this.add(t),this.stack.push(t)}closeNode(){if(this.stack.length>1)return this.stack.pop()}closeAllNodes(){for(;this.closeNode(););}toJSON(){return JSON.stringify(this.rootNode,null,4)}walk(n){return this.constructor._walk(n,this.rootNode)}static _walk(n,t){return typeof t=="string"?n.addText(t):t.children&&(n.openNode(t),t.children.forEach(a=>this._walk(n,a)),n.closeNode(t)),n}static _collapse(n){typeof n!="string"&&n.children&&(n.children.every(t=>typeof t=="string")?n.children=[n.children.join("")]:n.children.forEach(t=>{tn._collapse(t)}))}}class Rt extends tn{constructor(n){super(),this.options=n}addText(n){n!==""&&this.add(n)}startScope(n){this.openNode(n)}endScope(){this.closeNode()}__addSublanguage(n,t){const a=n.root;t&&(a.scope=`language:${t}`),this.add(a)}toHTML(){return new $t(this,this.options).value()}finalize(){return this.closeAllNodes(),!0}}function Ne(e){return e?typeof e=="string"?e:e.source:null}function Mn(e){return we("(?=",e,")")}function Mt(e){return we("(?:",e,")*")}function Lt(e){return we("(?:",e,")?")}function we(...e){return e.map(t=>Ne(t)).join("")}function Ot(e){const n=e[e.length-1];return typeof n=="object"&&n.constructor===Object?(e.splice(e.length-1,1),n):{}}function an(...e){return"("+(Ot(e).capture?"":"?:")+e.map(a=>Ne(a)).join("|")+")"}function Ln(e){return new RegExp(e.toString()+"|").exec("").length-1}function Dt(e,n){const t=e&&e.exec(n);return t&&t.index===0}const Bt=/\[(?:[^\\\]]|\\.)*\]|\(\??|\\([1-9][0-9]*)|\\./;function sn(e,{joinWith:n}){let t=0;return e.map(a=>{t+=1;const o=t;let r=Ne(a),s="";for(;r.length>0;){const i=Bt.exec(r);if(!i){s+=r;break}s+=r.substring(0,i.index),r=r.substring(i.index+i[0].length),i[0][0]==="\\"&&i[1]?s+="\\"+String(Number(i[1])+o):(s+=i[0],i[0]==="("&&t++)}return s}).map(a=>`(${a})`).join(n)}const Pt=/\b\B/,On="[a-zA-Z]\\w*",on="[a-zA-Z_]\\w*",Dn="\\b\\d+(\\.\\d+)?",Bn="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",Pn="\\b(0b[01]+)",Ut="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~",Ft=(e={})=>{const n=/^#![ ]*\//;return e.binary&&(e.begin=we(n,/.*\b/,e.binary,/\b.*/)),ge({scope:"meta",begin:n,end:/$/,relevance:0,"on:begin":(t,a)=>{t.index!==0&&a.ignoreMatch()}},e)},Ce={begin:"\\\\[\\s\\S]",relevance:0},Ht={scope:"string",begin:"'",end:"'",illegal:"\\n",contains:[Ce]},Gt={scope:"string",begin:'"',end:'"',illegal:"\\n",contains:[Ce]},zt={begin:/\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/},Ge=function(e,n,t={}){const a=ge({scope:"comment",begin:e,end:n,contains:[]},t);a.contains.push({scope:"doctag",begin:"[ ]*(?=(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):)",end:/(TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):/,excludeBegin:!0,relevance:0});const o=an("I","a","is","so","us","to","at","if","in","it","on",/[A-Za-z]+['](d|ve|re|ll|t|s|n)/,/[A-Za-z]+[-][a-z]+/,/[A-Za-z][a-z]{2,}/);return a.contains.push({begin:we(/[ ]+/,"(",o,/[.]?[:]?([.][ ]|[ ])/,"){3}")}),a},Wt=Ge("//","$"),qt=Ge("/\\*","\\*/"),Vt=Ge("#","$"),jt={scope:"number",begin:Dn,relevance:0},Kt={scope:"number",begin:Bn,relevance:0},Zt={scope:"number",begin:Pn,relevance:0},Yt={scope:"regexp",begin:/\/(?=[^/\n]*\/)/,end:/\/[gimuy]*/,contains:[Ce,{begin:/\[/,end:/\]/,relevance:0,contains:[Ce]}]},Xt={scope:"title",begin:On,relevance:0},Jt={scope:"title",begin:on,relevance:0},Qt={begin:"\\.\\s*"+on,relevance:0},ea=function(e){return Object.assign(e,{"on:begin":(n,t)=>{t.data._beginMatch=n[1]},"on:end":(n,t)=>{t.data._beginMatch!==n[1]&&t.ignoreMatch()}})};var Oe=Object.freeze({__proto__:null,APOS_STRING_MODE:Ht,BACKSLASH_ESCAPE:Ce,BINARY_NUMBER_MODE:Zt,BINARY_NUMBER_RE:Pn,COMMENT:Ge,C_BLOCK_COMMENT_MODE:qt,C_LINE_COMMENT_MODE:Wt,C_NUMBER_MODE:Kt,C_NUMBER_RE:Bn,END_SAME_AS_BEGIN:ea,HASH_COMMENT_MODE:Vt,IDENT_RE:On,MATCH_NOTHING_RE:Pt,METHOD_GUARD:Qt,NUMBER_MODE:jt,NUMBER_RE:Dn,PHRASAL_WORDS_MODE:zt,QUOTE_STRING_MODE:Gt,REGEXP_MODE:Yt,RE_STARTERS_RE:Ut,SHEBANG:Ft,TITLE_MODE:Xt,UNDERSCORE_IDENT_RE:on,UNDERSCORE_TITLE_MODE:Jt});function na(e,n){e.input[e.index-1]==="."&&n.ignoreMatch()}function ta(e,n){e.className!==void 0&&(e.scope=e.className,delete e.className)}function aa(e,n){n&&e.beginKeywords&&(e.begin="\\b("+e.beginKeywords.split(" ").join("|")+")(?!\\.)(?=\\b|\\s)",e.__beforeBegin=na,e.keywords=e.keywords||e.beginKeywords,delete e.beginKeywords,e.relevance===void 0&&(e.relevance=0))}function sa(e,n){Array.isArray(e.illegal)&&(e.illegal=an(...e.illegal))}function ia(e,n){if(e.match){if(e.begin||e.end)throw new Error("begin & end are not supported with match");e.begin=e.match,delete e.match}}function oa(e,n){e.relevance===void 0&&(e.relevance=1)}const ra=(e,n)=>{if(!e.beforeMatch)return;if(e.starts)throw new Error("beforeMatch cannot be used with starts");const t=Object.assign({},e);Object.keys(e).forEach(a=>{delete e[a]}),e.keywords=t.keywords,e.begin=we(t.beforeMatch,Mn(t.begin)),e.starts={relevance:0,contains:[Object.assign(t,{endsParent:!0})]},e.relevance=0,delete t.beforeMatch},ca=["of","and","for","in","not","or","if","then","parent","list","value"],la="keyword";function Un(e,n,t=la){const a=Object.create(null);return typeof e=="string"?o(t,e.split(" ")):Array.isArray(e)?o(t,e):Object.keys(e).forEach(function(r){Object.assign(a,Un(e[r],n,r))}),a;function o(r,s){n&&(s=s.map(i=>i.toLowerCase())),s.forEach(function(i){const c=i.split("|");a[c[0]]=[r,da(c[0],c[1])]})}}function da(e,n){return n?Number(n):ua(e)?0:1}function ua(e){return ca.includes(e.toLowerCase())}const hn={},ye=e=>{console.error(e)},bn=(e,...n)=>{console.log(`WARN: ${e}`,...n)},Ae=(e,n)=>{hn[`${e}/${n}`]||(console.log(`Deprecated as of ${e}. ${n}`),hn[`${e}/${n}`]=!0)},Ue=new Error;function Fn(e,n,{key:t}){let a=0;const o=e[t],r={},s={};for(let i=1;i<=n.length;i++)s[i+a]=o[i],r[i+a]=!0,a+=Ln(n[i-1]);e[t]=s,e[t]._emit=r,e[t]._multi=!0}function pa(e){if(Array.isArray(e.begin)){if(e.skip||e.excludeBegin||e.returnBegin)throw ye("skip, excludeBegin, returnBegin not compatible with beginScope: {}"),Ue;if(typeof e.beginScope!="object"||e.beginScope===null)throw ye("beginScope must be object"),Ue;Fn(e,e.begin,{key:"beginScope"}),e.begin=sn(e.begin,{joinWith:""})}}function ga(e){if(Array.isArray(e.end)){if(e.skip||e.excludeEnd||e.returnEnd)throw ye("skip, excludeEnd, returnEnd not compatible with endScope: {}"),Ue;if(typeof e.endScope!="object"||e.endScope===null)throw ye("endScope must be object"),Ue;Fn(e,e.end,{key:"endScope"}),e.end=sn(e.end,{joinWith:""})}}function ma(e){e.scope&&typeof e.scope=="object"&&e.scope!==null&&(e.beginScope=e.scope,delete e.scope)}function fa(e){ma(e),typeof e.beginScope=="string"&&(e.beginScope={_wrap:e.beginScope}),typeof e.endScope=="string"&&(e.endScope={_wrap:e.endScope}),pa(e),ga(e)}function ha(e){function n(s,i){return new RegExp(Ne(s),"m"+(e.case_insensitive?"i":"")+(e.unicodeRegex?"u":"")+(i?"g":""))}class t{constructor(){this.matchIndexes={},this.regexes=[],this.matchAt=1,this.position=0}addRule(i,c){c.position=this.position++,this.matchIndexes[this.matchAt]=c,this.regexes.push([c,i]),this.matchAt+=Ln(i)+1}compile(){this.regexes.length===0&&(this.exec=()=>null);const i=this.regexes.map(c=>c[1]);this.matcherRe=n(sn(i,{joinWith:"|"}),!0),this.lastIndex=0}exec(i){this.matcherRe.lastIndex=this.lastIndex;const c=this.matcherRe.exec(i);if(!c)return null;const l=c.findIndex((p,b)=>b>0&&p!==void 0),d=this.matchIndexes[l];return c.splice(0,l),Object.assign(c,d)}}class a{constructor(){this.rules=[],this.multiRegexes=[],this.count=0,this.lastIndex=0,this.regexIndex=0}getMatcher(i){if(this.multiRegexes[i])return this.multiRegexes[i];const c=new t;return this.rules.slice(i).forEach(([l,d])=>c.addRule(l,d)),c.compile(),this.multiRegexes[i]=c,c}resumingScanAtSamePosition(){return this.regexIndex!==0}considerAll(){this.regexIndex=0}addRule(i,c){this.rules.push([i,c]),c.type==="begin"&&this.count++}exec(i){const c=this.getMatcher(this.regexIndex);c.lastIndex=this.lastIndex;let l=c.exec(i);if(this.resumingScanAtSamePosition()&&!(l&&l.index===this.lastIndex)){const d=this.getMatcher(0);d.lastIndex=this.lastIndex+1,l=d.exec(i)}return l&&(this.regexIndex+=l.position+1,this.regexIndex===this.count&&this.considerAll()),l}}function o(s){const i=new a;return s.contains.forEach(c=>i.addRule(c.begin,{rule:c,type:"begin"})),s.terminatorEnd&&i.addRule(s.terminatorEnd,{type:"end"}),s.illegal&&i.addRule(s.illegal,{type:"illegal"}),i}function r(s,i){const c=s;if(s.isCompiled)return c;[ta,ia,fa,ra].forEach(d=>d(s,i)),e.compilerExtensions.forEach(d=>d(s,i)),s.__beforeBegin=null,[aa,sa,oa].forEach(d=>d(s,i)),s.isCompiled=!0;let l=null;return typeof s.keywords=="object"&&s.keywords.$pattern&&(s.keywords=Object.assign({},s.keywords),l=s.keywords.$pattern,delete s.keywords.$pattern),l=l||/\w+/,s.keywords&&(s.keywords=Un(s.keywords,e.case_insensitive)),c.keywordPatternRe=n(l,!0),i&&(s.begin||(s.begin=/\B|\b/),c.beginRe=n(c.begin),!s.end&&!s.endsWithParent&&(s.end=/\B|\b/),s.end&&(c.endRe=n(c.end)),c.terminatorEnd=Ne(c.end)||"",s.endsWithParent&&i.terminatorEnd&&(c.terminatorEnd+=(s.end?"|":"")+i.terminatorEnd)),s.illegal&&(c.illegalRe=n(s.illegal)),s.contains||(s.contains=[]),s.contains=[].concat(...s.contains.map(function(d){return ba(d==="self"?s:d)})),s.contains.forEach(function(d){r(d,c)}),s.starts&&r(s.starts,i),c.matcher=o(c),c}if(e.compilerExtensions||(e.compilerExtensions=[]),e.contains&&e.contains.includes("self"))throw new Error("ERR: contains `self` is not supported at the top-level of a language.  See documentation.");return e.classNameAliases=ge(e.classNameAliases||{}),r(e)}function Hn(e){return e?e.endsWithParent||Hn(e.starts):!1}function ba(e){return e.variants&&!e.cachedVariants&&(e.cachedVariants=e.variants.map(function(n){return ge(e,{variants:null},n)})),e.cachedVariants?e.cachedVariants:Hn(e)?ge(e,{starts:e.starts?ge(e.starts):null}):Object.isFrozen(e)?ge(e):e}var ya="11.11.1";class wa extends Error{constructor(n,t){super(n),this.name="HTMLInjectionError",this.html=t}}const Ye=Rn,yn=ge,wn=Symbol("nomatch"),Ea=7,Gn=function(e){const n=Object.create(null),t=Object.create(null),a=[];let o=!0;const r="Could not find the language '{}', did you forget to load/include a language module?",s={disableAutodetect:!0,name:"Plain text",contains:[]};let i={ignoreUnescapedHTML:!1,throwUnescapedHTML:!1,noHighlightRe:/^(no-?highlight)$/i,languageDetectRe:/\blang(?:uage)?-([\w-]+)\b/i,classPrefix:"hljs-",cssSelector:"pre code",languages:null,__emitter:Rt};function c(u){return i.noHighlightRe.test(u)}function l(u){let f=u.className+" ";f+=u.parentNode?u.parentNode.className:"";const m=i.languageDetectRe.exec(f);if(m){const A=F(m[1]);return A||(bn(r.replace("{}",m[1])),bn("Falling back to no-highlight mode for this block.",u)),A?m[1]:"no-highlight"}return f.split(/\s+/).find(A=>c(A)||F(A))}function d(u,f,m){let A="",k="";typeof f=="object"?(A=u,m=f.ignoreIllegals,k=f.language):(Ae("10.7.0","highlight(lang, code, ...args) has been deprecated."),Ae("10.7.0",`Please use highlight(code, options) instead.
https://github.com/highlightjs/highlight.js/issues/2277`),k=u,A=f),m===void 0&&(m=!0);const D={code:A,language:k};Q("before:highlight",D);const U=D.result?D.result:p(D.language,D.code,m);return U.code=D.code,Q("after:highlight",U),U}function p(u,f,m,A){const k=Object.create(null);function D(g,h){return g.keywords[h]}function U(){if(!v.keywords){G.addText(B);return}let g=0;v.keywordPatternRe.lastIndex=0;let h=v.keywordPatternRe.exec(B),x="";for(;h;){x+=B.substring(g,h.index);const C=X.case_insensitive?h[0].toLowerCase():h[0],z=D(v,C);if(z){const[le,yt]=z;if(G.addText(x),x="",k[C]=(k[C]||0)+1,k[C]<=Ea&&(Le+=yt),le.startsWith("_"))x+=h[0];else{const wt=X.classNameAliases[le]||le;K(h[0],wt)}}else x+=h[0];g=v.keywordPatternRe.lastIndex,h=v.keywordPatternRe.exec(B)}x+=B.substring(g),G.addText(x)}function Y(){if(B==="")return;let g=null;if(typeof v.subLanguage=="string"){if(!n[v.subLanguage]){G.addText(B);return}g=p(v.subLanguage,B,!0,Me[v.subLanguage]),Me[v.subLanguage]=g._top}else g=y(B,v.subLanguage.length?v.subLanguage:null);v.relevance>0&&(Le+=g.relevance),G.__addSublanguage(g._emitter,g.language)}function q(){v.subLanguage!=null?Y():U(),B=""}function K(g,h){g!==""&&(G.startScope(h),G.addText(g),G.endScope())}function Ee(g,h){let x=1;const C=h.length-1;for(;x<=C;){if(!g._emit[x]){x++;continue}const z=X.classNameAliases[g[x]]||g[x],le=h[x];z?K(le,z):(B=le,U(),B=""),x++}}function $e(g,h){return g.scope&&typeof g.scope=="string"&&G.openNode(X.classNameAliases[g.scope]||g.scope),g.beginScope&&(g.beginScope._wrap?(K(B,X.classNameAliases[g.beginScope._wrap]||g.beginScope._wrap),B=""):g.beginScope._multi&&(Ee(g.beginScope,h),B="")),v=Object.create(g,{parent:{value:v}}),v}function Te(g,h,x){let C=Dt(g.endRe,x);if(C){if(g["on:end"]){const z=new gn(g);g["on:end"](h,z),z.isMatchIgnored&&(C=!1)}if(C){for(;g.endsParent&&g.parent;)g=g.parent;return g}}if(g.endsWithParent)return Te(g.parent,h,x)}function We(g){return v.matcher.regexIndex===0?(B+=g[0],1):(Ze=!0,0)}function qe(g){const h=g[0],x=g.rule,C=new gn(x),z=[x.__beforeBegin,x["on:begin"]];for(const le of z)if(le&&(le(g,C),C.isMatchIgnored))return We(h);return x.skip?B+=h:(x.excludeBegin&&(B+=h),q(),!x.returnBegin&&!x.excludeBegin&&(B=h)),$e(x,g),x.returnBegin?0:h.length}function Ve(g){const h=g[0],x=f.substring(g.index),C=Te(v,g,x);if(!C)return wn;const z=v;v.endScope&&v.endScope._wrap?(q(),K(h,v.endScope._wrap)):v.endScope&&v.endScope._multi?(q(),Ee(v.endScope,g)):z.skip?B+=h:(z.returnEnd||z.excludeEnd||(B+=h),q(),z.excludeEnd&&(B=h));do v.scope&&G.closeNode(),!v.skip&&!v.subLanguage&&(Le+=v.relevance),v=v.parent;while(v!==C.parent);return C.starts&&$e(C.starts,g),z.returnEnd?0:h.length}function je(){const g=[];for(let h=v;h!==X;h=h.parent)h.scope&&g.unshift(h.scope);g.forEach(h=>G.openNode(h))}let ve={};function Re(g,h){const x=h&&h[0];if(B+=g,x==null)return q(),0;if(ve.type==="begin"&&h.type==="end"&&ve.index===h.index&&x===""){if(B+=f.slice(h.index,h.index+1),!o){const C=new Error(`0 width match regex (${u})`);throw C.languageName=u,C.badRule=ve.rule,C}return 1}if(ve=h,h.type==="begin")return qe(h);if(h.type==="illegal"&&!m){const C=new Error('Illegal lexeme "'+x+'" for mode "'+(v.scope||"<unnamed>")+'"');throw C.mode=v,C}else if(h.type==="end"){const C=Ve(h);if(C!==wn)return C}if(h.type==="illegal"&&x==="")return B+=`
`,1;if(Ke>1e5&&Ke>h.index*3)throw new Error("potential infinite loop, way more iterations than matches");return B+=x,x.length}const X=F(u);if(!X)throw ye(r.replace("{}",u)),new Error('Unknown language: "'+u+'"');const R=ha(X);let pe="",v=A||R;const Me={},G=new i.__emitter(i);je();let B="",Le=0,be=0,Ke=0,Ze=!1;try{if(X.__emitTokens)X.__emitTokens(f,G);else{for(v.matcher.considerAll();;){Ke++,Ze?Ze=!1:v.matcher.considerAll(),v.matcher.lastIndex=be;const g=v.matcher.exec(f);if(!g)break;const h=f.substring(be,g.index),x=Re(h,g);be=g.index+x}Re(f.substring(be))}return G.finalize(),pe=G.toHTML(),{language:u,value:pe,relevance:Le,illegal:!1,_emitter:G,_top:v}}catch(g){if(g.message&&g.message.includes("Illegal"))return{language:u,value:Ye(f),illegal:!0,relevance:0,_illegalBy:{message:g.message,index:be,context:f.slice(be-100,be+100),mode:g.mode,resultSoFar:pe},_emitter:G};if(o)return{language:u,value:Ye(f),illegal:!1,relevance:0,errorRaised:g,_emitter:G,_top:v};throw g}}function b(u){const f={value:Ye(u),illegal:!1,relevance:0,_top:s,_emitter:new i.__emitter(i)};return f._emitter.addText(u),f}function y(u,f){f=f||i.languages||Object.keys(n);const m=b(u),A=f.filter(F).filter(j).map(q=>p(q,u,!1));A.unshift(m);const k=A.sort((q,K)=>{if(q.relevance!==K.relevance)return K.relevance-q.relevance;if(q.language&&K.language){if(F(q.language).supersetOf===K.language)return 1;if(F(K.language).supersetOf===q.language)return-1}return 0}),[D,U]=k,Y=D;return Y.secondBest=U,Y}function w(u,f,m){const A=f&&t[f]||m;u.classList.add("hljs"),u.classList.add(`language-${A}`)}function E(u){let f=null;const m=l(u);if(c(m))return;if(Q("before:highlightElement",{el:u,language:m}),u.dataset.highlighted){console.log("Element previously highlighted. To highlight again, first unset `dataset.highlighted`.",u);return}if(u.children.length>0&&(i.ignoreUnescapedHTML||(console.warn("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),console.warn("https://github.com/highlightjs/highlight.js/wiki/security"),console.warn("The element with unescaped HTML:"),console.warn(u)),i.throwUnescapedHTML))throw new wa("One of your code blocks includes unescaped HTML.",u.innerHTML);f=u;const A=f.textContent,k=m?d(A,{language:m,ignoreIllegals:!0}):y(A);u.innerHTML=k.value,u.dataset.highlighted="yes",w(u,m,k.language),u.result={language:k.language,re:k.relevance,relevance:k.relevance},k.secondBest&&(u.secondBest={language:k.secondBest.language,relevance:k.secondBest.relevance}),Q("after:highlightElement",{el:u,result:k,text:A})}function S(u){i=yn(i,u)}const _=()=>{P(),Ae("10.6.0","initHighlighting() deprecated.  Use highlightAll() now.")};function T(){P(),Ae("10.6.0","initHighlightingOnLoad() deprecated.  Use highlightAll() now.")}let I=!1;function P(){function u(){P()}if(document.readyState==="loading"){I||window.addEventListener("DOMContentLoaded",u,!1),I=!0;return}document.querySelectorAll(i.cssSelector).forEach(E)}function $(u,f){let m=null;try{m=f(e)}catch(A){if(ye("Language definition for '{}' could not be registered.".replace("{}",u)),o)ye(A);else throw A;m=s}m.name||(m.name=u),n[u]=m,m.rawDefinition=f.bind(null,e),m.aliases&&O(m.aliases,{languageName:u})}function L(u){delete n[u];for(const f of Object.keys(t))t[f]===u&&delete t[f]}function Z(){return Object.keys(n)}function F(u){return u=(u||"").toLowerCase(),n[u]||n[t[u]]}function O(u,{languageName:f}){typeof u=="string"&&(u=[u]),u.forEach(m=>{t[m.toLowerCase()]=f})}function j(u){const f=F(u);return f&&!f.disableAutodetect}function fe(u){u["before:highlightBlock"]&&!u["before:highlightElement"]&&(u["before:highlightElement"]=f=>{u["before:highlightBlock"](Object.assign({block:f.el},f))}),u["after:highlightBlock"]&&!u["after:highlightElement"]&&(u["after:highlightElement"]=f=>{u["after:highlightBlock"](Object.assign({block:f.el},f))})}function ce(u){fe(u),a.push(u)}function ue(u){const f=a.indexOf(u);f!==-1&&a.splice(f,1)}function Q(u,f){const m=u;a.forEach(function(A){A[m]&&A[m](f)})}function he(u){return Ae("10.7.0","highlightBlock will be removed entirely in v12.0"),Ae("10.7.0","Please use highlightElement now."),E(u)}Object.assign(e,{highlight:d,highlightAuto:y,highlightAll:P,highlightElement:E,highlightBlock:he,configure:S,initHighlighting:_,initHighlightingOnLoad:T,registerLanguage:$,unregisterLanguage:L,listLanguages:Z,getLanguage:F,registerAliases:O,autoDetection:j,inherit:yn,addPlugin:ce,removePlugin:ue}),e.debugMode=function(){o=!1},e.safeMode=function(){o=!0},e.versionString=ya,e.regex={concat:we,lookahead:Mn,either:an,optional:Lt,anyNumberOfTimes:Mt};for(const u in Oe)typeof Oe[u]=="object"&&$n(Oe[u]);return Object.assign(e,Oe),e},_e=Gn({});_e.newInstance=()=>Gn({});var va=_e;_e.HighlightJS=_e;_e.default=_e;const oe=It(va);function Aa(e){const n=e.regex,t={},a={begin:/\$\{/,end:/\}/,contains:["self",{begin:/:-/,contains:[t]}]};Object.assign(t,{className:"variable",variants:[{begin:n.concat(/\$[\w\d#@][\w\d_]*/,"(?![\\w\\d])(?![$])")},a]});const o={className:"subst",begin:/\$\(/,end:/\)/,contains:[e.BACKSLASH_ESCAPE]},r=e.inherit(e.COMMENT(),{match:[/(^|\s)/,/#.*$/],scope:{2:"comment"}}),s={begin:/<<-?\s*(?=\w+)/,starts:{contains:[e.END_SAME_AS_BEGIN({begin:/(\w+)/,end:/(\w+)/,className:"string"})]}},i={className:"string",begin:/"/,end:/"/,contains:[e.BACKSLASH_ESCAPE,t,o]};o.contains.push(i);const c={match:/\\"/},l={className:"string",begin:/'/,end:/'/},d={match:/\\'/},p={begin:/\$?\(\(/,end:/\)\)/,contains:[{begin:/\d+#[0-9a-f]+/,className:"number"},e.NUMBER_MODE,t]},b=["fish","bash","zsh","sh","csh","ksh","tcsh","dash","scsh"],y=e.SHEBANG({binary:`(${b.join("|")})`,relevance:10}),w={className:"function",begin:/\w[\w\d_]*\s*\(\s*\)\s*\{/,returnBegin:!0,contains:[e.inherit(e.TITLE_MODE,{begin:/\w[\w\d_]*/})],relevance:0},E=["if","then","else","elif","fi","time","for","while","until","in","do","done","case","esac","coproc","function","select"],S=["true","false"],_={match:/(\/[a-z._-]+)+/},T=["break","cd","continue","eval","exec","exit","export","getopts","hash","pwd","readonly","return","shift","test","times","trap","umask","unset"],I=["alias","bind","builtin","caller","command","declare","echo","enable","help","let","local","logout","mapfile","printf","read","readarray","source","sudo","type","typeset","ulimit","unalias"],P=["autoload","bg","bindkey","bye","cap","chdir","clone","comparguments","compcall","compctl","compdescribe","compfiles","compgroups","compquote","comptags","comptry","compvalues","dirs","disable","disown","echotc","echoti","emulate","fc","fg","float","functions","getcap","getln","history","integer","jobs","kill","limit","log","noglob","popd","print","pushd","pushln","rehash","sched","setcap","setopt","stat","suspend","ttyctl","unfunction","unhash","unlimit","unsetopt","vared","wait","whence","where","which","zcompile","zformat","zftp","zle","zmodload","zparseopts","zprof","zpty","zregexparse","zsocket","zstyle","ztcp"],$=["chcon","chgrp","chown","chmod","cp","dd","df","dir","dircolors","ln","ls","mkdir","mkfifo","mknod","mktemp","mv","realpath","rm","rmdir","shred","sync","touch","truncate","vdir","b2sum","base32","base64","cat","cksum","comm","csplit","cut","expand","fmt","fold","head","join","md5sum","nl","numfmt","od","paste","ptx","pr","sha1sum","sha224sum","sha256sum","sha384sum","sha512sum","shuf","sort","split","sum","tac","tail","tr","tsort","unexpand","uniq","wc","arch","basename","chroot","date","dirname","du","echo","env","expr","factor","groups","hostid","id","link","logname","nice","nohup","nproc","pathchk","pinky","printenv","printf","pwd","readlink","runcon","seq","sleep","stat","stdbuf","stty","tee","test","timeout","tty","uname","unlink","uptime","users","who","whoami","yes"];return{name:"Bash",aliases:["sh","zsh"],keywords:{$pattern:/\b[a-z][a-z0-9._-]+\b/,keyword:E,literal:S,built_in:[...T,...I,"set","shopt",...P,...$]},contains:[y,e.SHEBANG(),w,p,r,s,_,i,c,l,d,t]}}const En="[A-Za-z$_][0-9A-Za-z$_]*",Sa=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends","using"],_a=["true","false","null","undefined","NaN","Infinity"],zn=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],Wn=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],qn=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],Ta=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],xa=[].concat(qn,zn,Wn);function ka(e){const n=e.regex,t=(m,{after:A})=>{const k="</"+m[0].slice(1);return m.input.indexOf(k,A)!==-1},a=En,o={begin:"<>",end:"</>"},r=/<[A-Za-z0-9\\._:-]+\s*\/>/,s={begin:/<[A-Za-z0-9\\._:-]+/,end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(m,A)=>{const k=m[0].length+m.index,D=m.input[k];if(D==="<"||D===","){A.ignoreMatch();return}D===">"&&(t(m,{after:k})||A.ignoreMatch());let U;const Y=m.input.substring(k);if(U=Y.match(/^\s*=/)){A.ignoreMatch();return}if((U=Y.match(/^\s+extends\s+/))&&U.index===0){A.ignoreMatch();return}}},i={$pattern:En,keyword:Sa,literal:_a,built_in:xa,"variable.language":Ta},c="[0-9](_?[0-9])*",l=`\\.(${c})`,d="0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*",p={className:"number",variants:[{begin:`(\\b(${d})((${l})|\\.)?|(${l}))[eE][+-]?(${c})\\b`},{begin:`\\b(${d})\\b((${l})\\b|\\.)?|(${l})\\b`},{begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-7](_?[0-7])*n?\\b"},{begin:"\\b0[0-7]+n?\\b"}],relevance:0},b={className:"subst",begin:"\\$\\{",end:"\\}",keywords:i,contains:[]},y={begin:".?html`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,b],subLanguage:"xml"}},w={begin:".?css`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,b],subLanguage:"css"}},E={begin:".?gql`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,b],subLanguage:"graphql"}},S={className:"string",begin:"`",end:"`",contains:[e.BACKSLASH_ESCAPE,b]},T={className:"comment",variants:[e.COMMENT(/\/\*\*(?!\/)/,"\\*/",{relevance:0,contains:[{begin:"(?=@[A-Za-z]+)",relevance:0,contains:[{className:"doctag",begin:"@[A-Za-z]+"},{className:"type",begin:"\\{",end:"\\}",excludeEnd:!0,excludeBegin:!0,relevance:0},{className:"variable",begin:a+"(?=\\s*(-)|$)",endsParent:!0,relevance:0},{begin:/(?=[^\n])\s/,relevance:0}]}]}),e.C_BLOCK_COMMENT_MODE,e.C_LINE_COMMENT_MODE]},I=[e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,y,w,E,S,{match:/\$\d+/},p];b.contains=I.concat({begin:/\{/,end:/\}/,keywords:i,contains:["self"].concat(I)});const P=[].concat(T,b.contains),$=P.concat([{begin:/(\s*)\(/,end:/\)/,keywords:i,contains:["self"].concat(P)}]),L={className:"params",begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:i,contains:$},Z={variants:[{match:[/class/,/\s+/,a,/\s+/,/extends/,/\s+/,n.concat(a,"(",n.concat(/\./,a),")*")],scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{match:[/class/,/\s+/,a],scope:{1:"keyword",3:"title.class"}}]},F={relevance:0,match:n.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),className:"title.class",keywords:{_:[...zn,...Wn]}},O={label:"use_strict",className:"meta",relevance:10,begin:/^\s*['"]use (strict|asm)['"]/},j={variants:[{match:[/function/,/\s+/,a,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},label:"func.def",contains:[L],illegal:/%/},fe={relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,className:"variable.constant"};function ce(m){return n.concat("(?!",m.join("|"),")")}const ue={match:n.concat(/\b/,ce([...qn,"super","import"].map(m=>`${m}\\s*\\(`)),a,n.lookahead(/\s*\(/)),className:"title.function",relevance:0},Q={begin:n.concat(/\./,n.lookahead(n.concat(a,/(?![0-9A-Za-z$_(])/))),end:a,excludeBegin:!0,keywords:"prototype",className:"property",relevance:0},he={match:[/get|set/,/\s+/,a,/(?=\()/],className:{1:"keyword",3:"title.function"},contains:[{begin:/\(\)/},L]},u="(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|"+e.UNDERSCORE_IDENT_RE+")\\s*=>",f={match:[/const|var|let/,/\s+/,a,/\s*/,/=\s*/,/(async\s*)?/,n.lookahead(u)],keywords:"async",className:{1:"keyword",3:"title.function"},contains:[L]};return{name:"JavaScript",aliases:["js","jsx","mjs","cjs"],keywords:i,exports:{PARAMS_CONTAINS:$,CLASS_REFERENCE:F},illegal:/#(?![$_A-z])/,contains:[e.SHEBANG({label:"shebang",binary:"node",relevance:5}),O,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,y,w,E,S,T,{match:/\$\d+/},p,F,{scope:"attr",match:a+n.lookahead(":"),relevance:0},f,{begin:"("+e.RE_STARTERS_RE+"|\\b(case|return|throw)\\b)\\s*",keywords:"return throw case",relevance:0,contains:[T,e.REGEXP_MODE,{className:"function",begin:u,returnBegin:!0,end:"\\s*=>",contains:[{className:"params",variants:[{begin:e.UNDERSCORE_IDENT_RE,relevance:0},{className:null,begin:/\(\s*\)/,skip:!0},{begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:i,contains:$}]}]},{begin:/,/,relevance:0},{match:/\s+/,relevance:0},{variants:[{begin:o.begin,end:o.end},{match:r},{begin:s.begin,"on:begin":s.isTrulyOpeningTag,end:s.end}],subLanguage:"xml",contains:[{begin:s.begin,end:s.end,skip:!0,contains:["self"]}]}]},j,{beginKeywords:"while if switch catch for"},{begin:"\\b(?!function)"+e.UNDERSCORE_IDENT_RE+"\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",returnBegin:!0,label:"func.def",contains:[L,e.inherit(e.TITLE_MODE,{begin:a,className:"title.function"})]},{match:/\.\.\./,relevance:0},Q,{match:"\\$"+a,relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},contains:[L]},ue,fe,Z,he,{match:/\$[(.]/}]}}function Ia(e){const n={className:"attr",begin:/"(\\.|[^\\"\r\n])*"(?=\s*:)/,relevance:1.01},t={match:/[{}[\],:]/,className:"punctuation",relevance:0},a=["true","false","null"],o={scope:"literal",beginKeywords:a.join(" ")};return{name:"JSON",aliases:["jsonc"],keywords:{literal:a},contains:[n,t,e.QUOTE_STRING_MODE,o,e.C_NUMBER_MODE,e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE],illegal:"\\S"}}function Na(e){const n=e.regex,t={begin:/<\/?[A-Za-z_]/,end:">",subLanguage:"xml",relevance:0},a={begin:"^[-\\*]{3,}",end:"$"},o={className:"code",variants:[{begin:"(`{3,})[^`](.|\\n)*?\\1`*[ ]*"},{begin:"(~{3,})[^~](.|\\n)*?\\1~*[ ]*"},{begin:"```",end:"```+[ ]*$"},{begin:"~~~",end:"~~~+[ ]*$"},{begin:"`.+?`"},{begin:"(?=^( {4}|\\t))",contains:[{begin:"^( {4}|\\t)",end:"(\\n)$"}],relevance:0}]},r={className:"bullet",begin:"^[ 	]*([*+-]|(\\d+\\.))(?=\\s+)",end:"\\s+",excludeEnd:!0},s={begin:/^\[[^\n]+\]:/,returnBegin:!0,contains:[{className:"symbol",begin:/\[/,end:/\]/,excludeBegin:!0,excludeEnd:!0},{className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]},i=/[A-Za-z][A-Za-z0-9+.-]*/,c={variants:[{begin:/\[.+?\]\[.*?\]/,relevance:0},{begin:/\[.+?\]\(((data|javascript|mailto):|(?:http|ftp)s?:\/\/).*?\)/,relevance:2},{begin:n.concat(/\[.+?\]\(/,i,/:\/\/.*?\)/),relevance:2},{begin:/\[.+?\]\([./?&#].*?\)/,relevance:1},{begin:/\[.*?\]\(.*?\)/,relevance:0}],returnBegin:!0,contains:[{match:/\[(?=\])/},{className:"string",relevance:0,begin:"\\[",end:"\\]",excludeBegin:!0,returnEnd:!0},{className:"link",relevance:0,begin:"\\]\\(",end:"\\)",excludeBegin:!0,excludeEnd:!0},{className:"symbol",relevance:0,begin:"\\]\\[",end:"\\]",excludeBegin:!0,excludeEnd:!0}]},l={className:"strong",contains:[],variants:[{begin:/_{2}(?!\s)/,end:/_{2}/},{begin:/\*{2}(?!\s)/,end:/\*{2}/}]},d={className:"emphasis",contains:[],variants:[{begin:/\*(?![*\s])/,end:/\*/},{begin:/_(?![_\s])/,end:/_/,relevance:0}]},p=e.inherit(l,{contains:[]}),b=e.inherit(d,{contains:[]});l.contains.push(b),d.contains.push(p);let y=[t,c];return[l,d,p,b].forEach(_=>{_.contains=_.contains.concat(y)}),y=y.concat(l,d),{name:"Markdown",aliases:["md","mkdown","mkd"],contains:[{className:"section",variants:[{begin:"^#{1,6}",end:"$",contains:y},{begin:"(?=^.+?\\n[=-]{2,}$)",contains:[{begin:"^[=-]*$"},{begin:"^",end:"\\n",contains:y}]}]},t,r,l,d,{className:"quote",begin:"^>\\s+",contains:y,end:"$"},o,a,c,s,{scope:"literal",match:/&([a-zA-Z0-9]+|#[0-9]{1,7}|#[Xx][0-9a-fA-F]{1,6});/}]}}function Vn(e){return e?typeof e=="string"?e:e.source:null}function xe(e){return M("(?=",e,")")}function M(...e){return e.map(t=>Vn(t)).join("")}function Ca(e){const n=e[e.length-1];return typeof n=="object"&&n.constructor===Object?(e.splice(e.length-1,1),n):{}}function V(...e){return"("+(Ca(e).capture?"":"?:")+e.map(a=>Vn(a)).join("|")+")"}const rn=e=>M(/\b/,e,/\w$/.test(e)?/\b/:/\B/),$a=["Protocol","Type"].map(rn),vn=["init","self"].map(rn),Ra=["Any","Self"],Xe=["actor","any","associatedtype","async","await",/as\?/,/as!/,"as","borrowing","break","case","catch","class","consume","consuming","continue","convenience","copy","default","defer","deinit","didSet","distributed","do","dynamic","each","else","enum","extension","fallthrough",/fileprivate\(set\)/,"fileprivate","final","for","func","get","guard","if","import","indirect","infix",/init\?/,/init!/,"inout",/internal\(set\)/,"internal","in","is","isolated","nonisolated","lazy","let","macro","mutating","nonmutating",/open\(set\)/,"open","operator","optional","override","package","postfix","precedencegroup","prefix",/private\(set\)/,"private","protocol",/public\(set\)/,"public","repeat","required","rethrows","return","set","some","static","struct","subscript","super","switch","throws","throw",/try\?/,/try!/,"try","typealias",/unowned\(safe\)/,/unowned\(unsafe\)/,"unowned","var","weak","where","while","willSet"],An=["false","nil","true"],Ma=["assignment","associativity","higherThan","left","lowerThan","none","right"],La=["#colorLiteral","#column","#dsohandle","#else","#elseif","#endif","#error","#file","#fileID","#fileLiteral","#filePath","#function","#if","#imageLiteral","#keyPath","#line","#selector","#sourceLocation","#warning"],Sn=["abs","all","any","assert","assertionFailure","debugPrint","dump","fatalError","getVaList","isKnownUniquelyReferenced","max","min","numericCast","pointwiseMax","pointwiseMin","precondition","preconditionFailure","print","readLine","repeatElement","sequence","stride","swap","swift_unboxFromSwiftValueWithType","transcode","type","unsafeBitCast","unsafeDowncast","withExtendedLifetime","withUnsafeMutablePointer","withUnsafePointer","withVaList","withoutActuallyEscaping","zip"],jn=V(/[/=\-+!*%<>&|^~?]/,/[\u00A1-\u00A7]/,/[\u00A9\u00AB]/,/[\u00AC\u00AE]/,/[\u00B0\u00B1]/,/[\u00B6\u00BB\u00BF\u00D7\u00F7]/,/[\u2016-\u2017]/,/[\u2020-\u2027]/,/[\u2030-\u203E]/,/[\u2041-\u2053]/,/[\u2055-\u205E]/,/[\u2190-\u23FF]/,/[\u2500-\u2775]/,/[\u2794-\u2BFF]/,/[\u2E00-\u2E7F]/,/[\u3001-\u3003]/,/[\u3008-\u3020]/,/[\u3030]/),Kn=V(jn,/[\u0300-\u036F]/,/[\u1DC0-\u1DFF]/,/[\u20D0-\u20FF]/,/[\uFE00-\uFE0F]/,/[\uFE20-\uFE2F]/),Je=M(jn,Kn,"*"),Zn=V(/[a-zA-Z_]/,/[\u00A8\u00AA\u00AD\u00AF\u00B2-\u00B5\u00B7-\u00BA]/,/[\u00BC-\u00BE\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF]/,/[\u0100-\u02FF\u0370-\u167F\u1681-\u180D\u180F-\u1DBF]/,/[\u1E00-\u1FFF]/,/[\u200B-\u200D\u202A-\u202E\u203F-\u2040\u2054\u2060-\u206F]/,/[\u2070-\u20CF\u2100-\u218F\u2460-\u24FF\u2776-\u2793]/,/[\u2C00-\u2DFF\u2E80-\u2FFF]/,/[\u3004-\u3007\u3021-\u302F\u3031-\u303F\u3040-\uD7FF]/,/[\uF900-\uFD3D\uFD40-\uFDCF\uFDF0-\uFE1F\uFE30-\uFE44]/,/[\uFE47-\uFEFE\uFF00-\uFFFD]/),Fe=V(Zn,/\d/,/[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/),se=M(Zn,Fe,"*"),De=M(/[A-Z]/,Fe,"*"),Oa=["attached","autoclosure",M(/convention\(/,V("swift","block","c"),/\)/),"discardableResult","dynamicCallable","dynamicMemberLookup","escaping","freestanding","frozen","GKInspectable","IBAction","IBDesignable","IBInspectable","IBOutlet","IBSegueAction","inlinable","main","nonobjc","NSApplicationMain","NSCopying","NSManaged",M(/objc\(/,se,/\)/),"objc","objcMembers","propertyWrapper","requires_stored_property_inits","resultBuilder","Sendable","testable","UIApplicationMain","unchecked","unknown","usableFromInline","warn_unqualified_access"],Da=["iOS","iOSApplicationExtension","macOS","macOSApplicationExtension","macCatalyst","macCatalystApplicationExtension","watchOS","watchOSApplicationExtension","tvOS","tvOSApplicationExtension","swift"];function Ba(e){const n={match:/\s+/,relevance:0},t=e.COMMENT("/\\*","\\*/",{contains:["self"]}),a=[e.C_LINE_COMMENT_MODE,t],o={match:[/\./,V(...$a,...vn)],className:{2:"keyword"}},r={match:M(/\./,V(...Xe)),relevance:0},s=Xe.filter(R=>typeof R=="string").concat(["_|0"]),i=Xe.filter(R=>typeof R!="string").concat(Ra).map(rn),c={variants:[{className:"keyword",match:V(...i,...vn)}]},l={$pattern:V(/\b\w+/,/#\w+/),keyword:s.concat(La),literal:An},d=[o,r,c],p={match:M(/\./,V(...Sn)),relevance:0},b={className:"built_in",match:M(/\b/,V(...Sn),/(?=\()/)},y=[p,b],w={match:/->/,relevance:0},E={className:"operator",relevance:0,variants:[{match:Je},{match:`\\.(\\.|${Kn})+`}]},S=[w,E],_="([0-9]_*)+",T="([0-9a-fA-F]_*)+",I={className:"number",relevance:0,variants:[{match:`\\b(${_})(\\.(${_}))?([eE][+-]?(${_}))?\\b`},{match:`\\b0x(${T})(\\.(${T}))?([pP][+-]?(${_}))?\\b`},{match:/\b0o([0-7]_*)+\b/},{match:/\b0b([01]_*)+\b/}]},P=(R="")=>({className:"subst",variants:[{match:M(/\\/,R,/[0\\tnr"']/)},{match:M(/\\/,R,/u\{[0-9a-fA-F]{1,8}\}/)}]}),$=(R="")=>({className:"subst",match:M(/\\/,R,/[\t ]*(?:[\r\n]|\r\n)/)}),L=(R="")=>({className:"subst",label:"interpol",begin:M(/\\/,R,/\(/),end:/\)/}),Z=(R="")=>({begin:M(R,/"""/),end:M(/"""/,R),contains:[P(R),$(R),L(R)]}),F=(R="")=>({begin:M(R,/"/),end:M(/"/,R),contains:[P(R),L(R)]}),O={className:"string",variants:[Z(),Z("#"),Z("##"),Z("###"),F(),F("#"),F("##"),F("###")]},j=[e.BACKSLASH_ESCAPE,{begin:/\[/,end:/\]/,relevance:0,contains:[e.BACKSLASH_ESCAPE]}],fe={begin:/\/[^\s](?=[^/\n]*\/)/,end:/\//,contains:j},ce=R=>{const pe=M(R,/\//),v=M(/\//,R);return{begin:pe,end:v,contains:[...j,{scope:"comment",begin:`#(?!.*${v})`,end:/$/}]}},ue={scope:"regexp",variants:[ce("###"),ce("##"),ce("#"),fe]},Q={match:M(/`/,se,/`/)},he={className:"variable",match:/\$\d+/},u={className:"variable",match:`\\$${Fe}+`},f=[Q,he,u],m={match:/(@|#(un)?)available/,scope:"keyword",starts:{contains:[{begin:/\(/,end:/\)/,keywords:Da,contains:[...S,I,O]}]}},A={scope:"keyword",match:M(/@/,V(...Oa),xe(V(/\(/,/\s+/)))},k={scope:"meta",match:M(/@/,se)},D=[m,A,k],U={match:xe(/\b[A-Z]/),relevance:0,contains:[{className:"type",match:M(/(AV|CA|CF|CG|CI|CL|CM|CN|CT|MK|MP|MTK|MTL|NS|SCN|SK|UI|WK|XC)/,Fe,"+")},{className:"type",match:De,relevance:0},{match:/[?!]+/,relevance:0},{match:/\.\.\./,relevance:0},{match:M(/\s+&\s+/,xe(De)),relevance:0}]},Y={begin:/</,end:/>/,keywords:l,contains:[...a,...d,...D,w,U]};U.contains.push(Y);const q={match:M(se,/\s*:/),keywords:"_|0",relevance:0},K={begin:/\(/,end:/\)/,relevance:0,keywords:l,contains:["self",q,...a,ue,...d,...y,...S,I,O,...f,...D,U]},Ee={begin:/</,end:/>/,keywords:"repeat each",contains:[...a,U]},$e={begin:V(xe(M(se,/\s*:/)),xe(M(se,/\s+/,se,/\s*:/))),end:/:/,relevance:0,contains:[{className:"keyword",match:/\b_\b/},{className:"params",match:se}]},Te={begin:/\(/,end:/\)/,keywords:l,contains:[$e,...a,...d,...S,I,O,...D,U,K],endsParent:!0,illegal:/["']/},We={match:[/(func|macro)/,/\s+/,V(Q.match,se,Je)],className:{1:"keyword",3:"title.function"},contains:[Ee,Te,n],illegal:[/\[/,/%/]},qe={match:[/\b(?:subscript|init[?!]?)/,/\s*(?=[<(])/],className:{1:"keyword"},contains:[Ee,Te,n],illegal:/\[|%/},Ve={match:[/operator/,/\s+/,Je],className:{1:"keyword",3:"title"}},je={begin:[/precedencegroup/,/\s+/,De],className:{1:"keyword",3:"title"},contains:[U],keywords:[...Ma,...An],end:/}/},ve={match:[/class\b/,/\s+/,/func\b/,/\s+/,/\b[A-Za-z_][A-Za-z0-9_]*\b/],scope:{1:"keyword",3:"keyword",5:"title.function"}},Re={match:[/class\b/,/\s+/,/var\b/],scope:{1:"keyword",3:"keyword"}},X={begin:[/(struct|protocol|class|extension|enum|actor)/,/\s+/,se,/\s*/],beginScope:{1:"keyword",3:"title.class"},keywords:l,contains:[Ee,...d,{begin:/:/,end:/\{/,keywords:l,contains:[{scope:"title.class.inherited",match:De},...d],relevance:0}]};for(const R of O.variants){const pe=R.contains.find(Me=>Me.label==="interpol");pe.keywords=l;const v=[...d,...y,...S,I,O,...f];pe.contains=[...v,{begin:/\(/,end:/\)/,contains:["self",...v]}]}return{name:"Swift",keywords:l,contains:[...a,We,qe,ve,Re,X,Ve,je,{beginKeywords:"import",end:/$/,contains:[...a],relevance:0},ue,...d,...y,...S,I,O,...f,...D,U,K]}}const He="[A-Za-z$_][0-9A-Za-z$_]*",Yn=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends","using"],Xn=["true","false","null","undefined","NaN","Infinity"],Jn=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],Qn=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],et=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],nt=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],tt=[].concat(et,Jn,Qn);function Pa(e){const n=e.regex,t=(m,{after:A})=>{const k="</"+m[0].slice(1);return m.input.indexOf(k,A)!==-1},a=He,o={begin:"<>",end:"</>"},r=/<[A-Za-z0-9\\._:-]+\s*\/>/,s={begin:/<[A-Za-z0-9\\._:-]+/,end:/\/[A-Za-z0-9\\._:-]+>|\/>/,isTrulyOpeningTag:(m,A)=>{const k=m[0].length+m.index,D=m.input[k];if(D==="<"||D===","){A.ignoreMatch();return}D===">"&&(t(m,{after:k})||A.ignoreMatch());let U;const Y=m.input.substring(k);if(U=Y.match(/^\s*=/)){A.ignoreMatch();return}if((U=Y.match(/^\s+extends\s+/))&&U.index===0){A.ignoreMatch();return}}},i={$pattern:He,keyword:Yn,literal:Xn,built_in:tt,"variable.language":nt},c="[0-9](_?[0-9])*",l=`\\.(${c})`,d="0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*",p={className:"number",variants:[{begin:`(\\b(${d})((${l})|\\.)?|(${l}))[eE][+-]?(${c})\\b`},{begin:`\\b(${d})\\b((${l})\\b|\\.)?|(${l})\\b`},{begin:"\\b(0|[1-9](_?[0-9])*)n\\b"},{begin:"\\b0[xX][0-9a-fA-F](_?[0-9a-fA-F])*n?\\b"},{begin:"\\b0[bB][0-1](_?[0-1])*n?\\b"},{begin:"\\b0[oO][0-7](_?[0-7])*n?\\b"},{begin:"\\b0[0-7]+n?\\b"}],relevance:0},b={className:"subst",begin:"\\$\\{",end:"\\}",keywords:i,contains:[]},y={begin:".?html`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,b],subLanguage:"xml"}},w={begin:".?css`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,b],subLanguage:"css"}},E={begin:".?gql`",end:"",starts:{end:"`",returnEnd:!1,contains:[e.BACKSLASH_ESCAPE,b],subLanguage:"graphql"}},S={className:"string",begin:"`",end:"`",contains:[e.BACKSLASH_ESCAPE,b]},T={className:"comment",variants:[e.COMMENT(/\/\*\*(?!\/)/,"\\*/",{relevance:0,contains:[{begin:"(?=@[A-Za-z]+)",relevance:0,contains:[{className:"doctag",begin:"@[A-Za-z]+"},{className:"type",begin:"\\{",end:"\\}",excludeEnd:!0,excludeBegin:!0,relevance:0},{className:"variable",begin:a+"(?=\\s*(-)|$)",endsParent:!0,relevance:0},{begin:/(?=[^\n])\s/,relevance:0}]}]}),e.C_BLOCK_COMMENT_MODE,e.C_LINE_COMMENT_MODE]},I=[e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,y,w,E,S,{match:/\$\d+/},p];b.contains=I.concat({begin:/\{/,end:/\}/,keywords:i,contains:["self"].concat(I)});const P=[].concat(T,b.contains),$=P.concat([{begin:/(\s*)\(/,end:/\)/,keywords:i,contains:["self"].concat(P)}]),L={className:"params",begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:i,contains:$},Z={variants:[{match:[/class/,/\s+/,a,/\s+/,/extends/,/\s+/,n.concat(a,"(",n.concat(/\./,a),")*")],scope:{1:"keyword",3:"title.class",5:"keyword",7:"title.class.inherited"}},{match:[/class/,/\s+/,a],scope:{1:"keyword",3:"title.class"}}]},F={relevance:0,match:n.either(/\bJSON/,/\b[A-Z][a-z]+([A-Z][a-z]*|\d)*/,/\b[A-Z]{2,}([A-Z][a-z]+|\d)+([A-Z][a-z]*)*/,/\b[A-Z]{2,}[a-z]+([A-Z][a-z]+|\d)*([A-Z][a-z]*)*/),className:"title.class",keywords:{_:[...Jn,...Qn]}},O={label:"use_strict",className:"meta",relevance:10,begin:/^\s*['"]use (strict|asm)['"]/},j={variants:[{match:[/function/,/\s+/,a,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],className:{1:"keyword",3:"title.function"},label:"func.def",contains:[L],illegal:/%/},fe={relevance:0,match:/\b[A-Z][A-Z_0-9]+\b/,className:"variable.constant"};function ce(m){return n.concat("(?!",m.join("|"),")")}const ue={match:n.concat(/\b/,ce([...et,"super","import"].map(m=>`${m}\\s*\\(`)),a,n.lookahead(/\s*\(/)),className:"title.function",relevance:0},Q={begin:n.concat(/\./,n.lookahead(n.concat(a,/(?![0-9A-Za-z$_(])/))),end:a,excludeBegin:!0,keywords:"prototype",className:"property",relevance:0},he={match:[/get|set/,/\s+/,a,/(?=\()/],className:{1:"keyword",3:"title.function"},contains:[{begin:/\(\)/},L]},u="(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|"+e.UNDERSCORE_IDENT_RE+")\\s*=>",f={match:[/const|var|let/,/\s+/,a,/\s*/,/=\s*/,/(async\s*)?/,n.lookahead(u)],keywords:"async",className:{1:"keyword",3:"title.function"},contains:[L]};return{name:"JavaScript",aliases:["js","jsx","mjs","cjs"],keywords:i,exports:{PARAMS_CONTAINS:$,CLASS_REFERENCE:F},illegal:/#(?![$_A-z])/,contains:[e.SHEBANG({label:"shebang",binary:"node",relevance:5}),O,e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,y,w,E,S,T,{match:/\$\d+/},p,F,{scope:"attr",match:a+n.lookahead(":"),relevance:0},f,{begin:"("+e.RE_STARTERS_RE+"|\\b(case|return|throw)\\b)\\s*",keywords:"return throw case",relevance:0,contains:[T,e.REGEXP_MODE,{className:"function",begin:u,returnBegin:!0,end:"\\s*=>",contains:[{className:"params",variants:[{begin:e.UNDERSCORE_IDENT_RE,relevance:0},{className:null,begin:/\(\s*\)/,skip:!0},{begin:/(\s*)\(/,end:/\)/,excludeBegin:!0,excludeEnd:!0,keywords:i,contains:$}]}]},{begin:/,/,relevance:0},{match:/\s+/,relevance:0},{variants:[{begin:o.begin,end:o.end},{match:r},{begin:s.begin,"on:begin":s.isTrulyOpeningTag,end:s.end}],subLanguage:"xml",contains:[{begin:s.begin,end:s.end,skip:!0,contains:["self"]}]}]},j,{beginKeywords:"while if switch catch for"},{begin:"\\b(?!function)"+e.UNDERSCORE_IDENT_RE+"\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)\\s*\\{",returnBegin:!0,label:"func.def",contains:[L,e.inherit(e.TITLE_MODE,{begin:a,className:"title.function"})]},{match:/\.\.\./,relevance:0},Q,{match:"\\$"+a,relevance:0},{match:[/\bconstructor(?=\s*\()/],className:{1:"title.function"},contains:[L]},ue,fe,Z,he,{match:/\$[(.]/}]}}function Ua(e){const n=e.regex,t=Pa(e),a=He,o=["any","void","number","boolean","string","object","never","symbol","bigint","unknown"],r={begin:[/namespace/,/\s+/,e.IDENT_RE],beginScope:{1:"keyword",3:"title.class"}},s={beginKeywords:"interface",end:/\{/,excludeEnd:!0,keywords:{keyword:"interface extends",built_in:o},contains:[t.exports.CLASS_REFERENCE]},i={className:"meta",relevance:10,begin:/^\s*['"]use strict['"]/},c=["type","interface","public","private","protected","implements","declare","abstract","readonly","enum","override","satisfies"],l={$pattern:He,keyword:Yn.concat(c),literal:Xn,built_in:tt.concat(o),"variable.language":nt},d={className:"meta",begin:"@"+a},p=(E,S,_)=>{const T=E.contains.findIndex(I=>I.label===S);if(T===-1)throw new Error("can not find mode to replace");E.contains.splice(T,1,_)};Object.assign(t.keywords,l),t.exports.PARAMS_CONTAINS.push(d);const b=t.contains.find(E=>E.scope==="attr"),y=Object.assign({},b,{match:n.concat(a,n.lookahead(/\s*\?:/))});t.exports.PARAMS_CONTAINS.push([t.exports.CLASS_REFERENCE,b,y]),t.contains=t.contains.concat([d,r,s,y]),p(t,"shebang",e.SHEBANG()),p(t,"use_strict",i);const w=t.contains.find(E=>E.label==="func.def");return w.relevance=0,Object.assign(t,{name:"TypeScript",aliases:["ts","tsx","mts","cts"]}),t}function Fa(e){const n=e.regex,t=n.concat(/[\p{L}_]/u,n.optional(/[\p{L}0-9_.-]*:/u),/[\p{L}0-9_.-]*/u),a=/[\p{L}0-9._:-]+/u,o={className:"symbol",begin:/&[a-z]+;|&#[0-9]+;|&#x[a-f0-9]+;/},r={begin:/\s/,contains:[{className:"keyword",begin:/#?[a-z_][a-z1-9_-]+/,illegal:/\n/}]},s=e.inherit(r,{begin:/\(/,end:/\)/}),i=e.inherit(e.APOS_STRING_MODE,{className:"string"}),c=e.inherit(e.QUOTE_STRING_MODE,{className:"string"}),l={endsWithParent:!0,illegal:/</,relevance:0,contains:[{className:"attr",begin:a,relevance:0},{begin:/=\s*/,relevance:0,contains:[{className:"string",endsParent:!0,variants:[{begin:/"/,end:/"/,contains:[o]},{begin:/'/,end:/'/,contains:[o]},{begin:/[^\s"'=<>`]+/}]}]}]};return{name:"HTML, XML",aliases:["html","xhtml","rss","atom","xjb","xsd","xsl","plist","wsf","svg"],case_insensitive:!0,unicodeRegex:!0,contains:[{className:"meta",begin:/<![a-z]/,end:/>/,relevance:10,contains:[r,c,i,s,{begin:/\[/,end:/\]/,contains:[{className:"meta",begin:/<![a-z]/,end:/>/,contains:[r,s,c,i]}]}]},e.COMMENT(/<!--/,/-->/,{relevance:10}),{begin:/<!\[CDATA\[/,end:/\]\]>/,relevance:10},o,{className:"meta",end:/\?>/,variants:[{begin:/<\?xml/,relevance:10,contains:[c]},{begin:/<\?[a-z][a-z0-9]+/}]},{className:"tag",begin:/<style(?=\s|>)/,end:/>/,keywords:{name:"style"},contains:[l],starts:{end:/<\/style>/,returnEnd:!0,subLanguage:["css","xml"]}},{className:"tag",begin:/<script(?=\s|>)/,end:/>/,keywords:{name:"script"},contains:[l],starts:{end:/<\/script>/,returnEnd:!0,subLanguage:["javascript","handlebars","xml"]}},{className:"tag",begin:/<>|<\/>/},{className:"tag",begin:n.concat(/</,n.lookahead(n.concat(t,n.either(/\/>/,/>/,/\s/)))),end:/\/?>/,contains:[{className:"name",begin:t,relevance:0,starts:l}]},{className:"tag",begin:n.concat(/<\//,n.lookahead(n.concat(t,/>/))),contains:[{className:"name",begin:t,relevance:0},{begin:/>/,relevance:0,endsParent:!0}]}]}}function Ha(e){const n="true false yes no null",t="[\\w#;/?:@&=+$,.~*'()[\\]]+",a={className:"attr",variants:[{begin:/[\w*@][\w*@ :()\./-]*:(?=[ \t]|$)/},{begin:/"[\w*@][\w*@ :()\./-]*":(?=[ \t]|$)/},{begin:/'[\w*@][\w*@ :()\./-]*':(?=[ \t]|$)/}]},o={className:"template-variable",variants:[{begin:/\{\{/,end:/\}\}/},{begin:/%\{/,end:/\}/}]},r={className:"string",relevance:0,begin:/'/,end:/'/,contains:[{match:/''/,scope:"char.escape",relevance:0}]},s={className:"string",relevance:0,variants:[{begin:/"/,end:/"/},{begin:/\S+/}],contains:[e.BACKSLASH_ESCAPE,o]},i=e.inherit(s,{variants:[{begin:/'/,end:/'/,contains:[{begin:/''/,relevance:0}]},{begin:/"/,end:/"/},{begin:/[^\s,{}[\]]+/}]}),b={className:"number",begin:"\\b"+"[0-9]{4}(-[0-9][0-9]){0,2}"+"([Tt \\t][0-9][0-9]?(:[0-9][0-9]){2})?"+"(\\.[0-9]*)?"+"([ \\t])*(Z|[-+][0-9][0-9]?(:[0-9][0-9])?)?"+"\\b"},y={end:",",endsWithParent:!0,excludeEnd:!0,keywords:n,relevance:0},w={begin:/\{/,end:/\}/,contains:[y],illegal:"\\n",relevance:0},E={begin:"\\[",end:"\\]",contains:[y],illegal:"\\n",relevance:0},S=[a,{className:"meta",begin:"^---\\s*$",relevance:10},{className:"string",begin:"[\\|>]([1-9]?[+-])?[ ]*\\n( +)[^ ][^\\n]*\\n(\\2[^\\n]+\\n?)*"},{begin:"<%[%=-]?",end:"[%-]?%>",subLanguage:"ruby",excludeBegin:!0,excludeEnd:!0,relevance:0},{className:"type",begin:"!\\w+!"+t},{className:"type",begin:"!<"+t+">"},{className:"type",begin:"!"+t},{className:"type",begin:"!!"+t},{className:"meta",begin:"&"+e.UNDERSCORE_IDENT_RE+"$"},{className:"meta",begin:"\\*"+e.UNDERSCORE_IDENT_RE+"$"},{className:"bullet",begin:"-(?=[ ]|$)",relevance:0},e.HASH_COMMENT_MODE,{beginKeywords:n,keywords:{literal:n}},b,{className:"number",begin:e.C_NUMBER_RE+"\\b",relevance:0},w,E,r,s],_=[...S];return _.pop(),_.push(i),y.contains=_,{name:"YAML",case_insensitive:!0,aliases:["yml"],contains:S}}oe.registerLanguage("bash",Aa);oe.registerLanguage("javascript",ka);oe.registerLanguage("json",Ia);oe.registerLanguage("markdown",Na);oe.registerLanguage("swift",e=>{const n=Ba(e);return n.contains=[{scope:"property",begin:/\.[A-Za-z_]\w*/},...n.contains??[]],n});oe.registerLanguage("typescript",Ua);oe.registerLanguage("xml",Fa);oe.registerLanguage("yaml",Ha);const Ga={html:"xml",js:"javascript",md:"markdown",sh:"bash",shell:"bash",ts:"typescript",txt:"plaintext",yml:"yaml"};function at(e){const n=e.trim().toLowerCase();return Ga[n]??n}function st(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function it(e){const n=at(e);return n?`language-${st(n)}`:"language-plaintext"}function ot(e,n){const t=at(n);return!t||t==="plaintext"||!oe.getLanguage(t)?st(e):oe.highlight(e,{language:t,ignoreIllegals:!0}).value}function za(e,n){const t=e.replace(/\r\n?/g,`
`).split(`
`);return t.length>1&&t[t.length-1]===""&&t.pop(),t.map((a,o)=>`<span class="code-line"><span class="code-line-number" aria-hidden="true">${o+1}</span><span class="code-line-content">${ot(a,n)}</span></span>`).join("")}const Wa=`---
...
`,qa=[{name:"Vladislav Prusakov",description:"AdaEngine Founder, iOS Engineer",username:"SpectralDragon",avatar:"authors/spectraldragon.jpg",socials:[{username:"SpectralDragon",social:"github"},{username:"SpectralDragon_",social:"twitter"}]}],Va={},ja=qa,Ka=Va?Object.assign({"./content/articles/introducing-adaengine-0-1-0.md":Wa}):{};function Za(e){const n=e.replace(/\r\n/g,`
`);if(!n.startsWith(`---
`))return{frontmatter:{},body:n.trim()};const t=n.indexOf(`
---
`,4);if(t===-1)return{frontmatter:{},body:n.trim()};const a=n.slice(4,t),o=n.slice(t+5).trim(),r={};let s=null;for(const i of a.split(`
`)){const c=i.trim();if(!c){s=null;continue}if(c.startsWith("- ")&&s){const b=r[s],y=_n(c.slice(2).trim()),w=Array.isArray(b)?b:[];w.push(y),r[s]=w;continue}const l=i.indexOf(":");if(l===-1){s=null;continue}const d=i.slice(0,l).trim(),p=i.slice(l+1).trim();if(!p){r[d]=[],s=d;continue}r[d]=_n(p),s=null}return{frontmatter:r,body:o}}function _n(e){return e.startsWith("[")&&e.endsWith("]")?e.slice(1,-1).split(",").map(n=>n.trim().replace(/^['"]|['"]$/g,"")).filter(Boolean):e==="true"?!0:e==="false"?!1:e.replace(/^['"]|['"]$/g,"")}function ie(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function Ya(e){return/^(https?:|data:|blob:|\/)/.test(e)?e:`${"/".endsWith("/")?"/":"//"}${e.replace(/^\/+/,"")}`}function rt(e){return/^https?:\/\//.test(e)}function Qe(e){return e.trim().replace(/^@/,"").toLowerCase()}function Xa(e){var t;if(typeof e.url=="string")return e.url;if(typeof e.profileUrl=="string")return e.profileUrl;const n=(t=e.socials)==null?void 0:t.find(a=>a.social==="github");if(typeof(n==null?void 0:n.url)=="string")return n.url;if(typeof(n==null?void 0:n.username)=="string")return`https://github.com/${n.username.replace(/^@/,"")}`;if(typeof e.username=="string")return`https://github.com/${e.username.replace(/^@/,"")}`}function Ja(e,n){if(typeof e!="string"||!e.trim())throw new Error(`Invalid article author in ${n}`);const t=Qe(e),a=ja.find(o=>Qe(o.username??o.name)===t||Qe(o.name)===t);return a?{name:a.name,url:Xa(a),avatar:typeof a.avatar=="string"?a.avatar:void 0}:rt(e)?{name:e,url:e}:{name:e}}function Qa(e,n){if(!/^(https?:\/\/|\/|\.\/|\.\.\/|[A-Za-z0-9/_-])/.test(n))return Se(e);const t=ie(n),a=rt(n)?' target="_blank" rel="noreferrer"':"";return`<a href="${t}"${a}>${Se(e)}</a>`}function Se(e){return ie(e).replace(/`([^`]+)`/g,"<code>$1</code>").replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>").replace(/\*([^*]+)\*/g,"<em>$1</em>")}function es(e,n){let t=0;for(let a=n;a<e.length;a+=1){const o=e[a];if(o==="("){t+=1;continue}if(o===")"){if(t===0)return a;t-=1}}return-1}function de(e){let n="",t=0;for(;t<e.length;){const a=e.indexOf("[",t);if(a===-1){n+=Se(e.slice(t));break}const o=e.indexOf("]",a+1);if(o===-1||e[o+1]!=="("){n+=Se(e.slice(t,a+1)),t=a+1;continue}const r=o+2,s=es(e,r);if(s===-1){n+=Se(e.slice(t,a+1)),t=a+1;continue}n+=Se(e.slice(t,a)),n+=Qa(e.slice(a+1,o),e.slice(r,s)),t=s+1}return n}function ns(e){const n=e.toLowerCase();return{js:"JavaScript",javascript:"JavaScript",json:"JSON",md:"Markdown",markdown:"Markdown",sh:"Shell",shell:"Shell",swift:"Swift",ts:"TypeScript",typescript:"TypeScript",yaml:"YAML",yml:"YAML"}[n]??(e?e[0].toUpperCase()+e.slice(1):"Code")}function ts(e){var o;const n=e.match(/(?:^|\s)(?:title|filename)=["']([^"']+)["']/),t=((o=e.split(/\s+/)[0])==null?void 0:o.replace(/[^\w#+-]/g,""))??"",a=(n==null?void 0:n[1])??e.replace(t,"").trim().replace(/^["']|["']$/g,"");return{language:t,title:a}}function as(e,n,t){const a=ns(n);return`
    <figure class="article-code-block">
      <figcaption>
        <span>${ie(t)}</span>
        <span>${ie(a)}</span>
      </figcaption>
      <pre><code class="${it(n)}">${ot(e,n)}</code></pre>
    </figure>
  `}function ss(e){const n=e.match(/^!\[([^\]]*)\]\(([^)\s]+)(?:\s+"([^"]+)")?\)$/),t=e.match(/^::video\[([^\]]*)\]\(([^)\s]+)(?:\s+"([^"]+)")?\)$/),a=n??t;if(!a)return null;const[,o,r,s]=a,i=Ya(r),c=s||o,l=!!t||/\.(mp4|webm|ogg|mov)$/i.test(r),d=l?`<video controls playsinline preload="metadata" src="${ie(i)}">${ie(o)}</video>`:`<img src="${ie(i)}" alt="${ie(o)}" loading="lazy" role="button" tabindex="0" aria-label="Open image fullscreen" data-article-lightbox-image />`;return`
    <figure class="article-media ${l?"article-media-video":"article-media-image"}">
      ${d}
      ${c?`<figcaption>${de(c)}</figcaption>`:""}
    </figure>
  `}function is(e){const n=[];let t=!1;const a=()=>{t&&(n.push("</ul>"),t=!1)};for(const o of e){const r=o.trim();if(!r){a();continue}if(r.startsWith("- ")){t||(n.push("<ul>"),t=!0),n.push(`<li>${de(r.slice(2))}</li>`);continue}a(),n.push(`<p>${de(r)}</p>`)}return a(),n.join(`
`)}function os(e,n,t){const a=["note","tip","warning","danger","info"].includes(e)?e:"note";return`
  ...
  `}function Tn(e,n){const t=e.toLowerCase().replace(/`([^`]+)`/g,"$1").replace(/&[a-z]+;/gi,"").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"section",a=n.get(t)??0;return n.set(t,a+1),a===0?t:`${t}-${a+1}`}function rs(e){const n=e.split(`
`),t=[],a=[],o=new Map;let r=!1,s=!1,i="",c="",l=[],d=!1,p="note",b="",y=[];const w=()=>{r&&(t.push("</ul>"),r=!1)},E=()=>{s&&(t.push(as(l.join(`
`),i,c)),s=!1,i="",c="",l=[])},S=()=>{d&&(t.push(os(p,b,y)),d=!1,p="note",b="",y=[])};for(const _ of n){if(_.startsWith("```")){if(w(),S(),s)E();else{const $=ts(_.slice(3).trim());i=$.language,c=$.title,s=!0}continue}if(s){l.push(_);continue}if(_.trim()===":::"){w(),S();continue}if(d){y.push(_);continue}const T=_.trim();if(!T){w();continue}if(T.startsWith("- ")){r||(t.push("<ul>"),r=!0),t.push(`<li>${de(T.slice(2))}</li>`);continue}w();const I=T.match(/^:::(note|tip|warning|danger|info)(?:\s+(.+))?$/i);if(I){p=I[1].toLowerCase(),b=I[2]??"",y=[],d=!0;continue}const P=ss(T);if(P){t.push(P);continue}if(T.startsWith("### ")){const $=T.slice(4),L=Tn($,o);a.push({id:L,title:$,level:3}),t.push(`<h3 id="${ie(L)}">${de($)}</h3>`);continue}if(T.startsWith("## ")){const $=T.slice(3),L=Tn($,o);a.push({id:L,title:$,level:2}),t.push(`<h2 id="${ie(L)}">${de($)}</h2>`);continue}if(T.startsWith("# ")){t.push(`<h1>${de(T.slice(2))}</h1>`);continue}t.push(`<p>${de(T)}</p>`)}return w(),E(),S(),{html:t.join(`
`),toc:a}}function ct(e){return e.replace(/^#.*$/gm,"").replace(/```[\s\S]*?```/g,"").replace(/\[([^\]]+)\]\(([^)]+)\)/g,"$1").replace(/[*`_>#-]/g,"").replace(/\s+/g," ").trim()}function cs(e){return ct(e).slice(0,180)}function ls(e){const n=ct(e).split(" ").filter(Boolean).length;return Math.max(1,Math.ceil(n/180))}function ds(e,n){const t=e.title,a=e.slug,o=e.description,r=e.date,s=e.author,i=e.tags,c=e.image,l=e.published,d=e.draft,p=e.featured;if(typeof t!="string"||typeof a!="string"||typeof o!="string"||typeof r!="string")throw new Error(`Invalid article frontmatter in ${n}`);return{title:t,slug:a,description:o,date:r,author:Ja(s,n),tags:Array.isArray(i)?i.filter(b=>typeof b=="string"):[],image:typeof c=="string"?c:void 0,published:typeof l=="boolean"?l:!0,draft:typeof d=="boolean"?d:!1,featured:typeof p=="boolean"?p:!1}}const me=Object.entries(Ka).map(([e,n])=>{const{frontmatter:t,body:a}=Za(n),o=ds(t,e),r=rs(a);return{...o,excerpt:cs(a),html:r.html,readingTime:ls(a),toc:r.toc}}).filter(e=>e.published&&!e.draft).sort((e,n)=>new Date(n.date).getTime()-new Date(e.date).getTime());me.filter(e=>e.featured);function us(e){return me.find(n=>n.slug===e)}const en={schemaVersion:1,generatedAt:"",repository:"AdaEngine/AdaEngine",commit:null,demos:[]};let xn=null;const nn=new Map;function lt(e){return/^(https?:|data:|blob:|\/)/.test(e)?e:`${"/".endsWith("/")?"/":"//"}${e.replace(/^\/+/,"")}`}async function dt(){return xn??(xn=fetch(lt("demos/manifest.json"),{headers:{Accept:"application/json"}}).then(e=>e.ok?e.json():en).then(e=>({...en,...e,demos:[...e.demos??[]].sort((n,t)=>n.tag.localeCompare(t.tag)||n.title.localeCompare(t.title))})).catch(()=>en)),xn}async function ps(e){const n=lt(e.source);return nn.set(n,nn.get(n)??fetch(n).then(t=>{if(!t.ok)throw new Error(`Failed to load ${e.source}`);return t.text()}).catch(()=>"")),nn.get(n)??""}function gs(e,n){return e.demos.find(t=>t.slug===n)}function ms(e){const n=new Map;for(const t of e){const a=n.get(t.tag)??{tag:t.tag,title:t.tagTitle,demos:[]};a.demos.push(t),n.set(t.tag,a)}return[...n.values()]}function ut(e){const n=e.trim().replace(/\/$/,"");return!n||n==="."||n==="/"?"":n.startsWith("/")?n:`/${n}`}function fs(e,n){const t=ut(n);let a=e||"/";return a.startsWith("/")||(a=`/${a}`),t&&(a===t||a.startsWith(`${t}/`))&&(a=a.slice(t.length)||"/"),a=a.replace(/\/$/,"")||"/",a.startsWith("/")?a:`/${a}`}function hs(e,n){const t=ut(n),a=e.startsWith("/")?e:`/${e}`;return t?`${t}${a==="/"?"/":a}`:a}const bs=["learn","community","donate"];function pt(e,n){const t=fs(e,n);if(t==="/")return{name:"home"};if(t==="/download")return{name:"download"};if(t==="/blog")return{name:"blog"};if(t==="/demos")return{name:"demos"};const a=t.match(/^\/demos\/([^/]+)$/);if(a)return{name:"demo",slug:decodeURIComponent(a[1])};const o=bs.find(s=>t===`/${s}`);if(o)return{name:"static-page",page:o};const r=t.match(/^\/articles\/([^/]+)$/);return r?{name:"article",slug:decodeURIComponent(r[1])}:{name:"not-found",path:t}}const Ie="https://adaengine.org",ke="Ada",ee=`${Ie}/images/main/tilemap.png`,ys={learn:{title:"Learn Ada - Swift Game Engine Tutorials and Examples",description:"Learn Ada with Swift game development guides, ECS fundamentals, rendering notes, physics examples, and links to source code.",path:"/learn",image:ee,type:"website"},community:{title:"Ada Community - Swift Game Development Contributors",description:"Join the Ada community, follow development, discuss Swift game engine ideas, and contribute to the open-source project.",path:"/community",image:ee,type:"website"},donate:{title:"Support Ada - Open-Source Swift Game Engine",description:"Support Ada development through donations, code contributions, examples, bug reports, and documentation improvements.",path:"/donate",image:ee,type:"website"}};function cn(e){if(/^https?:\/\//.test(e))return e;const n=e.startsWith("/")?e:`/${e}`;return`${Ie}${n==="/"?"/":n.replace(/\/$/,"")}`}function ws(e){return e.name==="home"?{title:"Ada - Open-Source Swift Game Engine",description:"Ada is an open-source game engine for Swift developers, with ECS, 2D and 3D rendering, physics, UI, editor tooling, and WebAssembly demos.",path:"/",image:ee,type:"website"}:e.name==="download"?{title:"Download Ada — Mac, Windows, Linux and iOS",description:"Download Ada for your platform. Find desktop releases, source code and the iOS app on the App Store.",path:"/download",image:ee,type:"website"}:e.name==="blog"?{title:"Ada News - Swift Game Engine Updates",description:"Read Ada updates, release notes, engineering deep dives, and Swift game development articles from the project team.",path:"/blog",image:ee,type:"website"}:e.name==="demos"?{title:"Ada Demos - Swift WebAssembly Game Examples",description:"Explore Ada WebAssembly demos built from Swift source files, including 2D rendering, UI, physics, and scene examples.",path:"/demos",image:ee,type:"website"}:e.name==="static-page"?ys[e.page]:e.name==="demo"?{title:"Ada Demo - Swift WebAssembly Example",description:"This Ada demo page lists a Swift WebAssembly example when the demo is available.",path:`/demos/${e.slug}`,image:ee,type:"website",robots:"noindex, follow"}:e.name==="article"?{title:"Ada Article",description:"This Ada article page is available when the requested article has been published.",path:`/articles/${e.slug}`,image:ee,type:"article",robots:"noindex, follow"}:{title:"Page Not Found - Ada",description:"This Ada page could not be found. Return to the open-source Swift game engine homepage.",path:e.name==="not-found"?e.path:"/",image:ee,type:"website",robots:"noindex, follow"}}function Es(e){return{title:`${e.title} - Ada News`,description:e.description,path:`/articles/${e.slug}`,image:cn(e.image??"images/main/tilemap.png"),type:"article"}}function vs(e){return{title:`${e.title} - Ada WebAssembly Demo`,description:`${e.description} View the Swift source and run the WebAssembly build for this Ada demo.`,path:`/demos/${e.slug}`,image:ee,type:"website"}}function As(e){const n=cn(e.path),t={"@context":"https://schema.org","@type":"WebSite",name:ke,url:Ie,description:"Ada is an open-source Swift game engine for 2D and 3D games, ECS architecture, rendering, physics, UI, and demos."};return e.path==="/"?[t,{"@context":"https://schema.org","@type":"SoftwareSourceCode",name:ke,codeRepository:"https://github.com/AdaEngine/AdaEngine",programmingLanguage:"Swift",license:"https://github.com/AdaEngine/AdaEngine/blob/main/LICENSE",url:n,description:e.description}]:e.type==="article"?[t,{"@context":"https://schema.org","@type":"BlogPosting",headline:e.title,description:e.description,image:e.image,mainEntityOfPage:n,publisher:{"@type":"Organization",name:ke,url:Ie}}]:[t,{"@context":"https://schema.org","@type":"WebPage",name:e.title,description:e.description,url:n,isPartOf:{"@type":"WebSite",name:ke,url:Ie}}]}const te=document.querySelector("#app")??Ss(),Be="/";function Ss(){throw new Error("Root app container #app was not found")}const _s="Ada",gt="images/main/tilemap.png",kn=["images/main/tilemap.png","images/main/space_invaders.jpeg","images/main/duck_hunt.png"],mt="AdaEngine/AdaEngine",Ts={learn:{title:"Learn Ada",lead:"Master game development in Swift. From your first sprite to advanced Metal rendering techniques.",sections:[{title:"Documentation",body:"Read guides, API notes and examples for the engine core, ECS, renderer, physics and UI systems.",links:[{label:"Open documentation",href:"https://docs.adaengine.org/"}]},{title:"Examples",body:"Explore sample projects such as tilemaps, arcade games and Swift-first game prototypes.",links:[{label:"Browse examples",href:"https://github.com/AdaEngine/AdaEngine/tree/main/Examples"}]},{title:"Features",body:"Return to the home page feature overview for a quick summary of what Ada can do.",links:[{label:"View features",href:`${H("/")}#features`}]}]}},xs=[{title:"Getting Started",cards:[{title:"Get Started",body:"Install the engine and create your first window in under 5 minutes.",href:"https://docs.adaengine.org/tutorials/adaengine",icon:"book"},{title:"ECS",body:"Understand the Entity-Component-System architecture that powers Ada.",href:"https://docs.adaengine.org/documentation/adaecs/",icon:"play"},{title:"2D Physics Tutorial",body:"Add rigid bodies, collision shapes, and handle physics callbacks.",href:"https://docs.adaengine.org/documentation/adaphysics/",icon:"layout"}]},{title:"API Reference & Documentation",cards:[{title:"Core Framework",body:"Math, Collections, and basic Engine systems.",href:"https://docs.adaengine.org/documentation/adaengine/"},{title:"Rendering Pipeline",body:"Materials, Shaders, Render Graphs, and Metal integration.",href:"https://docs.adaengine.org/documentation/adarender/"},{title:"Audio System",body:"Spatial audio, sound effects, and music streaming.",href:"https://docs.adaengine.org/documentation/adaaudio/"}]}],ks=[{title:"GitHub",subtitle:"Contribute to source code",href:"https://github.com/AdaEngine/AdaEngine",icon:"images/socials/github.svg"},{title:"Discord",subtitle:"Live chat & support",href:"https://discord.gg/JkEPE7nwDu",icon:"images/socials/discord.svg"},{title:"Reddit",subtitle:"r/AdaEngine discussions",href:"https://www.reddit.com/r/AdaEngine/",icon:"images/socials/reddit.svg"},{title:"Telegram",subtitle:"Announcements channel",href:"https://t.me/adaengine",iconClass:"community-link-icon-telegram",iconMarkup:'<svg viewBox="0 0 48 48" aria-hidden="true"><path d="M42.2 8.7 35.8 39c-.5 2.1-1.8 2.6-3.6 1.6l-9.9-7.3-4.8 4.6c-.5.5-1 .9-2 .9l.7-10.1L34.6 12c.8-.7-.2-1.1-1.2-.4L10.6 25.9.8 22.8c-2.1-.7-2.2-2.1.4-3.1L39.5 4.9c1.8-.7 3.4.4 2.7 3.8Z"/></svg>'},{title:"X (Twitter)",subtitle:"Follow @ada_engine",href:"https://x.com/ada_engine",iconClass:"community-link-icon-x",iconMarkup:'<svg viewBox="0 0 48 48" aria-hidden="true"><path d="M28.4 20.6 43.1 4h-3.5L26.9 18.4 16.7 4H5l15.5 21.9L5 43.4h3.5L22 28.1l10.8 15.3h11.7L28.4 20.6Zm-4.8 5.4-1.6-2.2L9.6 6.5H15l10 14 1.6 2.2 13 18.2h-5.4L23.6 26Z"/></svg>'}],Is=[{title:"Boosty",subtitle:"Monthly Sponsorship",body:"Become a backer on Boosty to get early access to updates, exclusive tutorials, and your name in the engine credits.",href:"https://boosty.to/adaengine",action:"Support on Boosty",icon:"images/icons/ic_boosty.svg",tone:"boosty"},{title:"DonationAlerts",subtitle:"One-time Donation",body:"Prefer to make a one-time contribution? You can support us via DonationAlerts with various payment methods.",href:"https://www.donationalerts.com/r/adaengine",action:"Donate via DA",icon:"images/donation_alerts_logo.svg",tone:"donation-alerts"}],Pe=[{title:"Data Driven",description:"Ada build around custom Entity Component System. Simple to use, fast and cache-friendly for your game architecture.",details:"Ada is built around a custom, data-oriented Entity Component System inspired by modern Swift APIs. Components keep game state small and explicit, while systems operate through typed queries, resources, schedules and macros such as @Component and @System. This makes gameplay code modular, cache-friendly and easier to scale from a tiny prototype to a full scene with input, animation, physics and rendering working together.",code:`@Component
...
struct PlayerSystem: System {
    ...
    <section class="hero-section safe-area-insets">
      <div class="hero-copy">
        ...
        <div class="hero-actions">
          ...
          <a class="header-buttons-github" href="https://github.com/${mt}" aria-label="Ada on GitHub">
  ...
  `}function Os(e=[]){return e.length?`<ul class="tags">${e.map(n=>`<li>${n}</li>`).join("")}</ul>`:""}function Ds(){return me.length?`
              ...
              <article class="home-article-preview">
                <a href="${H(`/articles/${e.slug}`)}">
                  <div class="article-preview-image">
                    <img class="background_image" src="${W(gt)}" alt="${N(e.title)}" />
  ...
  `:""}function ft(e=[]){const n=e[0]??"News";return`<span class="blog-entry-tag blog-entry-tag-${["release","tutorial","engineering","markdown","frontmatter","vite"].find(a=>n.toLowerCase().includes(a))??"default"}">${N(n)}</span>`}function Bs(e,n){return e.image??kn[n%kn.length]??gt}function Ps(){te.innerHTML=`
    ${ae()}
                ...
                ${me.map((e,n)=>`
                      <article class="blog-entry">
                        ...
                        <a class="blog-entry-card" href="${H(`/articles/${e.slug}`)}">
                          <img class="blog-entry-cover" src="${W(Bs(e,n))}" alt="" loading="lazy" />
    ...
    ${re()}
  `}function Us(e){const n=ms(e.demos),t=n.map(a=>`
  ...
  `}async function Hs(e){const n=await dt(),t=gs(n,e);if(!t){ze("Demo not found","Check the address or return to the demos page.");return}dn(vs(t));const a=await ps(t),o=n.commit??"main",r=`https://github.com/${n.repository}/blob/${o}/${t.sourcePath}`;te.innerHTML=`
    ${ae()}
      ...
      <article class="container content-restriction demo-detail-page">
        ...
        <section class="demo-source-section" aria-labelledby="demo-source-title">
          ...
          <figure class="article-code-block demo-source-code">
            ...
            <pre class="code-with-line-numbers"><code class="${it("swift")}">${za(a,"swift")}</code></pre>
          </figure>
        </section>
      </article>
    </main>
  ...
  `}function zs(e){const n=e.gif?W(e.gif):"";return`
  ...
  `:""}function js(){const e=Ts.learn;te.innerHTML=`
    ${ae()}
    <main class="page-shell learn-page-shell">
      <section class="container content-restriction learn-page">
        ...
        ${xs.map(n=>{const t=n.title.replace(/\W+/g,"-").toLowerCase();return`
    ...
    ${re()}
  `}function Ks(e){if(e==="learn"){js();return}if(e==="community"){Ys();return}if(e==="donate"){Zs();return}}function Zs(){te.innerHTML=`
    ${ae()}
  ...
  `}function Xs(){te.innerHTML=`
    ...
    ${re()}
    ${Ws()}
  `}function Js(e){const n=us(e);if(!n){ze("Article not found","Check the address or return to the blog.");return}dn(Es(n)),te.innerHTML=`
    ${ae()}
  ...
  `}function ei(e){const n=`By ${e.name}`,a=`
    ${e.avatar?`<img class="article-author-avatar" src="${N(ni(e.avatar))}" alt="${N(`${e.name} avatar`)}" loading="lazy" />`:""}
    <span class="article-author-label">${N(n)}</span>
  `;return!e.url||!Ns(e.url)?`<span class="article-author">${a}</span>`:`
  ...
  `}function ni(e){return/^(https?:|data:|blob:|\/)/.test(e)||e.startsWith("images/")?W(e):W(`images/${e}`)}function In(e,n){return e.map(t=>`
        <a class="article-toc-link article-toc-link-level-${t.level}" href="#${t.id}" data-article-toc-link="${t.id}" data-toc-context="${n}">
          <span>${N(t.title)}</span>
        </a>
      `).join("")}function ti(e){var o;if(!e.length)return"";const n=In(e,"desktop"),t=In(e,"mobile"),a=((o=e[0])==null?void 0:o.title)??"Start";return`
  ...
  `}function ze(e="Page not found",n="This route does not exist yet."){te.innerHTML=`
    ${ae()}
    <main class="page-shell">
  ...
  `}function ai(){const e=document.querySelector(".article-content"),n=document.querySelector("[data-mobile-reader-nav]"),t=document.querySelector("[data-mobile-toc-toggle]"),a=document.querySelector("[data-mobile-toc-sheet]"),o=Array.from(document.querySelectorAll(".article-content h2[id], .article-content h3[id]")),r=Array.from(document.querySelectorAll("[data-article-toc-link]")),s=Array.from(document.querySelectorAll("[data-article-progress-fill]")),i=Array.from(document.querySelectorAll("[data-article-progress-label]")),c=Array.from(document.querySelectorAll("[data-current-section]"));if(!e||!o.length||!r.length)return;let l,d;const p=E=>{if(!(!t||!a||!n)){if(window.clearTimeout(l),t.setAttribute("aria-expanded",String(E)),E){a.hidden=!1,n.classList.remove("is-closing"),n.classList.add("is-open");return}n.classList.remove("is-open"),n.classList.add("is-closing"),l=window.setTimeout(()=>{a.hidden=!0,n.classList.remove("is-closing")},520)}},b=E=>{const S=document.getElementById(E);S&&(S.scrollIntoView({behavior:"smooth",block:"start"}),p(!1))},y=E=>{const S=E.closest(".article-toc-list, .article-mobile-toc-list");if(!S)return;const _=S.getBoundingClientRect(),T=E.getBoundingClientRect(),I=16,P=T.top<_.top+I,$=T.bottom>_.bottom-I;if(!P&&!$)return;const L=P?T.top-_.top-I:T.bottom-_.bottom+I;S.scrollTo({top:S.scrollTop+L,behavior:"smooth"})};r.forEach(E=>{E.addEventListener("click",S=>{const _=E.dataset.articleTocLink;_&&(S.preventDefault(),history.replaceState(null,"",`${window.location.pathname}${window.location.search}#${_}`),b(_))})}),t==null||t.addEventListener("click",()=>{const E=t.getAttribute("aria-expanded")==="true";p(!E)}),document.addEventListener("keydown",E=>{E.key==="Escape"&&p(!1)}),document.addEventListener("click",E=>{!n||!E.target||n.contains(E.target)||p(!1)});const w=()=>{var F;const E=window.scrollY+Math.min(180,window.innerHeight*.28),S=o.slice().reverse().find(O=>O.getBoundingClientRect().top+window.scrollY<=E)??o[0],_=S.id,T=e.offsetTop,I=e.offsetTop+e.scrollHeight-window.innerHeight,P=I<=T?1:Math.min(1,Math.max(0,(window.scrollY-T)/(I-T))),$=`${Math.round(P*100)}%`,L=((F=S.textContent)==null?void 0:F.trim())||"Start",Z=_!==d;d=_,s.forEach(O=>{O.style.transform=`scaleX(${P})`}),i.forEach(O=>{O.textContent=$}),c.forEach(O=>{O.textContent=L}),r.forEach(O=>{const j=O.dataset.articleTocLink===_;O.classList.toggle("is-active",j),O.setAttribute("aria-current",j?"true":"false"),j&&Z&&y(O)})};window.addEventListener("scroll",w,{passive:!0}),window.addEventListener("resize",w),w()}function si(){const e=Array.from(document.querySelectorAll("[data-demo-category-link]")),n=e.map(r=>{var s;return(s=document.getElementById(r.dataset.demoCategoryLink??""))==null?void 0:s.closest(".demo-group")}).filter(r=>!!r);if(!e.length||!n.length)return;let t;const a=r=>{const s=r.closest(".demo-category-list");if(!s||s.scrollWidth<=s.clientWidth)return;const i=s.getBoundingClientRect(),c=r.getBoundingClientRect(),l=12,d=c.left<i.left+l,p=c.right>i.right-l;if(!d&&!p)return;const b=d?c.left-i.left-l:c.right-i.right+l;s.scrollTo({left:s.scrollLeft+b,behavior:"smooth"})},o=()=>{var l;const r=window.scrollY+Math.min(180,window.innerHeight*.28),i=(l=(n.slice().reverse().find(d=>d.getBoundingClientRect().top+window.scrollY<=r)??n[0]).querySelector("h2[id]"))==null?void 0:l.id,c=i!==t;t=i,e.forEach(d=>{const p=d.dataset.demoCategoryLink===i;d.classList.toggle("is-active",p),p?d.setAttribute("aria-current","location"):d.removeAttribute("aria-current"),p&&c&&a(d)})};e.forEach(r=>{r.addEventListener("click",s=>{const i=r.dataset.demoCategoryLink,c=i?document.getElementById(i):null;!c||!i||(s.preventDefault(),history.replaceState(null,"",`${window.location.pathname}${window.location.search}#${i}`),c.scrollIntoView({behavior:"smooth",block:"start"}))})}),window.addEventListener("scroll",o,{passive:!0}),window.addEventListener("resize",o),o()}function ht(e){return[{id:"macos",title:"Mac",description:"The native editor for your Mac. Build with AdaScript and Swift."},{id:"windows",title:"Windows",description:"Create Ada games on your Windows PC."},{id:"linux",title:"Linux",description:"Build with the open-source engine on Linux."}].map(({id:t,title:a,description:o})=>{const r=Cn(t,e);return`<article class="platform-download" aria-labelledby="download-${t}">
      ...
      <div class="platform-download-actions">${r.length?r.map(s=>`<a class="header-buttons" href="${N(s.url)}">${Tt(s)}</a>`).join(""):`<span class="download-status">Installer coming soon</span><a class="download-source-link" href="${N(e.url)}">Get the source code ↗</a>`}</div>
    ...
    <div class="platform-download-actions"><a class="app-store-badge" href="${St}" aria-label="Download on the App Store"><img src="${W("images/downloads/app-store.svg")}" alt="Download on the App Store" width="120" height="40" /></a></div>
  </article>`}function ii(){te.innerHTML=`${ae()}
    <main class="page-shell download-page-shell"><section class="container content-restriction download-page">
      ...
      <div class="download-grid" data-download-cards>${ht(ne)}</div>
      <p class="download-footnote">Ada is free and open source. Desktop downloads appear here as installers are released.</p>
    </section></main>${re()}`}async function oi(){const e=await kt();document.querySelectorAll("[data-download-version]").forEach(t=>{t.textContent=`v${e.version}`}),document.querySelectorAll("[data-release-link]").forEach(t=>{t.href=e.url});const n=document.querySelector("[data-download-cards]");n&&(n.innerHTML=ht(e))}async function ri(){if(/^\/(cloud|games|legal)(\/|$)/.test(window.location.pathname)){const{renderCloud:n}=await At(async()=>{const{renderCloud:t}=await import("./cloud-CC7CsGsz.js");return{renderCloud:t}},__vite__mapDeps([0,1]));await n(te,ae,bt);return}const e=pt(window.location.pathname,"/");if(dn(ws(e)),e.name==="download"){ii();return}if(e.name==="home"){Xs();return}if(e.name==="blog"){Ps();return}if(e.name==="demos"){Us(await dt());return}if(e.name==="demo"){await Hs(e.slug);return}if(e.name==="static-page"){Ks(e.page);return}if(e.name==="article"){Js(e.slug);return}ze()}function bt(){const e=document.querySelector(".header"),n=document.querySelector(".burger-container");if(!e||e.dataset.navigationReady==="true")return;e.dataset.navigationReady="true";let t,a;const o=r=>{if(!(!e||!n)){if(window.clearTimeout(t),window.clearTimeout(a),e.classList.toggle("menu-opened",r),document.body.classList.toggle("menu-opened",r),n.setAttribute("aria-expanded",String(r)),n.setAttribute("aria-label",r?"Close menu":"Open menu"),r){e.classList.remove("menu-closing"),e.classList.add("menu-opening"),t=window.setTimeout(()=>{e.classList.remove("menu-opening")},620);return}e.classList.remove("menu-opening"),e.classList.add("menu-closing"),a=window.setTimeout(()=>{e.classList.remove("menu-closing")},760)}};n==null||n.addEventListener("click",()=>{o(!(e!=null&&e.classList.contains("menu-opened")))}),document.querySelectorAll(".navigation-item-link").forEach(r=>{r.addEventListener("click",()=>{o(!1)})})}function ci(){bt(),Nn();const e=document.querySelector(".feature-modal"),n=document.querySelector("#feature-modal-title"),t=document.querySelector("#feature-modal-description"),a=document.querySelector("#feature-modal-kicker"),o=document.querySelector("#feature-modal-visual"),r=()=>{e&&(e.hidden=!0,document.body.classList.remove("modal-opened"))};document.querySelectorAll("[data-feature-index]").forEach(s=>{s.addEventListener("click",()=>{const i=Number(s.dataset.featureIndex),c=Pe[i];!c||!e||!n||!t||!a||!o||(n.textContent=c.title,t.textContent=Cs(c),a.textContent=`Feature ${String(Number(s.dataset.featurePosition)||i+1).padStart(2,"0")}`,e.hidden=!1,document.body.classList.add("modal-opened"),o.innerHTML=di(c),Nn())})}),document.querySelectorAll("[data-modal-close]").forEach(s=>s.addEventListener("click",r)),document.addEventListener("keydown",s=>{s.key==="Escape"&&r()}),mi(),li(),pi(),gi(),si(),ai(),ui()}function Nn(){document.querySelectorAll("[data-feature-preview]:not([data-preview-listeners-ready])").forEach(e=>{const n=e.querySelector(".feature-media-gif");if(!n)return;e.dataset.previewListenersReady="true";const t=()=>e.classList.add("is-loaded");n.addEventListener("load",t,{once:!0}),n.addEventListener("error",()=>e.classList.add("has-load-error"),{once:!0}),n.complete&&n.naturalWidth>0&&t()})}function li(){const e=document.querySelector("[data-hero-gif-src]"),n=e==null?void 0:e.dataset.heroGifSrc;if(!e||!n)return;const t=new Image;t.onload=()=>{var i;t.className="hero-gif",t.alt="",t.decoding="async",(i=e.querySelector(".ae-logo-header"))==null||i.replaceWith(t);const a=document.createElement("canvas");a.width=1,a.height=1;const o=a.getContext("2d",{willReadFrequently:!0});if(!o)return;let r={red:34,green:148,blue:255};const s=()=>{try{o.clearRect(0,0,1,1),o.drawImage(t,0,0,1,1);const[c,l,d,p]=o.getImageData(0,0,1,1).data;p>0&&c+l+d>8&&(r={red:Math.round(r.red*.7+c*.3),green:Math.round(r.green*.7+l*.3),blue:Math.round(r.blue*.7+d*.3)},e.style.setProperty("--hero-ambient",`${r.red} ${r.green} ${r.blue}`),e.classList.add("has-ambient-light"))}catch{}window.setTimeout(s,600)};s()},t.src=n}function di(e){const n=e.gif?W(e.gif):"";return`
  ...
  `}function ui(){const e=document.querySelector("[data-article-lightbox]"),n=e==null?void 0:e.querySelector("[data-article-lightbox-preview]"),t=e==null?void 0:e.querySelector("[data-article-lightbox-caption]"),a=e==null?void 0:e.querySelector(".article-image-lightbox-close");let o=null;if(!e||!n||!t)return;const r=()=>{e.hidden=!0,n.removeAttribute("src"),document.body.classList.remove("article-lightbox-open"),o instanceof HTMLElement&&o.focus()},s=i=>{var d,p;const c=i.closest("figure"),l=((p=(d=c==null?void 0:c.querySelector("figcaption"))==null?void 0:d.textContent)==null?void 0:p.trim())??"";o=document.activeElement,n.src=i.currentSrc||i.src,n.alt=i.alt,t.textContent=l,t.hidden=!l,e.hidden=!1,document.body.classList.add("article-lightbox-open"),a==null||a.focus()};document.querySelectorAll("[data-article-lightbox-image]").forEach(i=>{i.addEventListener("click",()=>s(i)),i.addEventListener("keydown",c=>{c.key!=="Enter"&&c.key!==" "||(c.preventDefault(),s(i))})}),e.querySelectorAll("[data-article-lightbox-close]").forEach(i=>{i.addEventListener("click",r)}),document.addEventListener("keydown",i=>{i.key==="Escape"&&!e.hidden&&r()})}function pi(){const e=document.querySelector(".demo-player:not(.demo-player-empty)"),n=e==null?void 0:e.querySelector("[data-demo-fullscreen]");if(!e||!n)return;const t=document,a=e,o=document.fullscreenEnabled||t.webkitFullscreenEnabled||typeof e.requestFullscreen=="function"||typeof a.webkitRequestFullscreen=="function",r=()=>document.fullscreenElement??t.webkitFullscreenElement??null,s=()=>r()===e;let i=!1;const c=()=>{i=!0,e.classList.add("is-viewport-fullscreen"),document.body.classList.add("demo-viewport-fullscreen-open"),y()},l=()=>{i=!1,e.classList.remove("is-viewport-fullscreen"),document.body.classList.remove("demo-viewport-fullscreen-open"),y()},d=async()=>o?typeof e.requestFullscreen=="function"?(await e.requestFullscreen(),!0):typeof a.webkitRequestFullscreen=="function"?(await a.webkitRequestFullscreen(),!0):!1:!1,p=async()=>{try{if(await d())return}catch(w){console.warn("Native fullscreen is unavailable, using viewport fullscreen fallback",w)}c()},b=async()=>{var w;if(i){l();return}if(typeof document.exitFullscreen=="function"){await document.exitFullscreen();return}await((w=t.webkitExitFullscreen)==null?void 0:w.call(t))},y=()=>{const w=s()||i;e.classList.toggle("is-fullscreen",w),n.setAttribute("aria-label",w?"Exit demo fullscreen":"Open demo fullscreen"),n.title=w?"Exit fullscreen":"Open fullscreen"};n.addEventListener("click",async()=>{try{if(s()||i){await b();return}await p()}catch(w){console.error("Failed to toggle demo fullscreen",w)}}),document.addEventListener("fullscreenchange",y),document.addEventListener("webkitfullscreenchange",y),document.addEventListener("keydown",w=>{w.key==="Escape"&&i&&l()}),y()}function gi(){const e=document.querySelector(".demo-player:not(.demo-player-empty)"),n=e==null?void 0:e.querySelector("iframe");if(!e||!n)return;const t=document.createElement("canvas");t.width=1,t.height=1;const a=t.getContext("2d",{willReadFrequently:!0});if(!a)return;let o=0,r=0,s={red:34,green:211,blue:238};const i=(d,p,b)=>{s={red:Math.round(s.red*.7+d*.3),green:Math.round(s.green*.7+p*.3),blue:Math.round(s.blue*.7+b*.3)},e.style.setProperty("--demo-ambient",`${s.red} ${s.green} ${s.blue}`),e.classList.add("has-ambient-light")},c=d=>{if(d.origin!==window.location.origin)return;const p=d.data;if(!p||typeof p!="object"||p.type!=="ada-demo-ambient"||!Array.isArray(p.color)||p.color.length<3)return;const[b,y,w]=p.color.map(Number);[b,y,w].every(Number.isFinite)&&i(b,y,w)},l=()=>{var d;try{const p=(d=n.contentDocument)==null?void 0:d.querySelector("canvas");if(!p||p.width<=0||p.height<=0){r+=1,o=window.setTimeout(l,r<120?250:1e3);return}const b=Math.max(0,Math.floor(p.width*.5)),y=Math.max(0,Math.floor(p.height*.42));a.clearRect(0,0,1,1),a.drawImage(p,b,y,1,1,0,0,1,1);const[w,E,S,_]=a.getImageData(0,0,1,1).data;_>0&&w+E+S>8&&i(w,E,S),r=0,o=window.setTimeout(l,450)}catch{r+=1,o=window.setTimeout(l,r<12?450:1200)}};n.addEventListener("load",()=>{window.clearTimeout(o),r=0,o=window.setTimeout(l,500)}),window.addEventListener("message",c),o=window.setTimeout(l,500)}function mi(){const e=document.querySelector(".showcase-carousel"),n=Array.from(document.querySelectorAll(".showcase-slide")),t=Array.from(document.querySelectorAll(".showcase-carousel-dot"));if(!e||n.length<2)return;let a=0,o;const r=i=>{a=(i+n.length)%n.length,n.forEach((c,l)=>{const d=l===a;c.classList.toggle("is-active",d),c.setAttribute("aria-hidden",String(!d)),c.querySelectorAll("a").forEach(p=>{p.tabIndex=d?0:-1})}),t.forEach((c,l)=>{c.classList.toggle("is-active",l===a),c.setAttribute("aria-current",l===a?"true":"false")})},s=()=>{window.clearInterval(o),o=window.setInterval(()=>{r(a+1)},5e3)};t.forEach((i,c)=>{i.addEventListener("click",()=>{r(c),s()})}),e.addEventListener("mouseenter",()=>window.clearInterval(o)),e.addEventListener("mouseleave",s),e.addEventListener("focusin",()=>window.clearInterval(o)),e.addEventListener("focusout",s),r(0),s()}ri().catch(e=>{console.error(e),ze("Page failed to load","Refresh the page or try again in a moment.")}).then(()=>{try{ci()}catch(e){console.error("Failed to initialize page interactions",e)}Ms(),oi()});
